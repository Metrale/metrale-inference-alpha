...
// 2026-09-26: Kimi K3 SiTU-GLU MLP (model-arch kimi_k3/dense_cuda.rs) over resident FP32 or BF16 weights with
// FP32 activations; four warps per block, one output element per warp. Owner: b200 kernels. Invariants: none beyond the types.
#include <cuda_bf16.h>
#include <stdint.h>
