...
// 2026-09-25: Kernels `attn_prefill_paged_fp8k_turbo3v` and `_64`: paged prefill flash attention with an FP8 E4M3 K
...
// attn_prefill_paged_bf16k_turbo3v.cu's (arguments `tq3_v_bsb`, `tq3_v_dsb`).
//
// Owner: gb10 kernels.
...
#define KERNEL_NAME attn_prefill_paged_fp8k_turbo3v
