...
const URLS = {
  shellUrl: 'https://dev.metrale.ai/install.sh',
  powershellUrl: 'https://dev.metrale.ai/install.ps1',
};
...
describe('installCommandFor', () => {
  ...
  it('hands everyone else the shell installer', () => {
    for (const os of ['macos', 'linux', 'unknown']) {
      ...
      expect(command).toBe('curl -fsSL https://dev.metrale.ai/install.sh | sh');
    }
  });
