...
use metrale_plugin::coherence::{self, Report};
...
impl Preflight {
    ...
    pub fn begin(
        ...
        target: metrale_plugin::TargetEndpoint,
        expectation: Option<metrale_plugin::benchmark::ModelExpectation>,
    ...
    pub fn poll(&mut self, target: &metrale_plugin::TargetEndpoint) -> Option<bool> {
