...
# 2026-09-26: Quick TTFT and decode tok/s check over three prompt lengths, from the usage block.
#
# Owner: bench.
# Invariants: none beyond the types.
"""Quick Metrale Engine benchmark — measures TTFT and decode tok/s with minimal overhead."""
