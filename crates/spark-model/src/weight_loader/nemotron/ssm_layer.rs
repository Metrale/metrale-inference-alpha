...
impl NemotronHWeightLoader {
    ...
    pub(super) fn build_ssm_layer(
        ...
        // real block-scale buffer. `METRALE_NEMOTRON_NATIVE_FP8_SSM=0` restores
        ...
        // `METRALE_NEMOTRON_NATIVE_BF16_SSM=0` restores the legacy requant (A/B).
        ...
        // Cost: ~2.1 GB extra weights. METRALE_NO_SSM_PREFILL_T=1 keeps
        ...
        //     escape hatch via METRALE_NO_SSM_FP8_PREFILL=1.
        //
