...
//! 2026-09-25: `gated_delta_rule_prefill_split4` against an f64 CPU token-by-token GDN
//! recurrence, at Qwen3.6-35B-A3B GDN dimensions.
//!
//! Owner: model-arch examples.
//! Invariants:
//! - Exit 1 unless the output reaches cosine >= 0.999 against the reference for every t
//!   (64, 100, 128, 200).
//!
//!   cargo run -p metrale-model-arch --release --example gdn_split4_microtest --features cuda,gpu-examples
use anyhow::Result;
use half::bf16;
