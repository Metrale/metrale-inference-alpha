...
//!
//! Math lives in `metrale_core::kimi_k3` so Mac unit tests compile without
...
mod host_decode;
pub mod state;
pub use metrale_core::kimi_k3::{Ablation, K3CpuModel, K3LayerSpec, greedy_decode};
