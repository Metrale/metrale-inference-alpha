...
impl MoeLayer {
    ...
    pub fn new_with_hash(
        ...
        Ok(Self {
            ...
            // FP32 gate path (METRALE_FP32_GATE) — optional; KernelHandle(0) if the
            ...
            // FUSED FP4 gate_up kernel (METRALE_HOLO_MOE_GATEUP_FP4). try_kernel:
            ...
            moe_w8a8_native_m64_k: adaptive_fp8::native_m64_kernel(gpu),
            ...
            // Module name = file stem (default convention in metrale-kernels).
