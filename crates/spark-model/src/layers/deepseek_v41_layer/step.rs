...
/// `METRALE_DS41_TRACE=1`, read once: after every layer's attention and MoE
...
impl DeepSeekV41Layer {
    ...
    /// `METRALE_DS41_PREDICT_TRACE`: before this layer's routing, run its
    ...
    /// path `METRALE_DS41_GRAPH` unset (or `0`) takes, and prefill always.
