...
//! 2026-09-26: Tests for the concurrency leg's scoring. The fan-out itself
...
/// 2026-09-26: Every reply returned, none errored and the counts agreed, but
/// one reply was wrong: the level is not ok.
#[test]
...
/// 2026-09-26: Two prompt-token counts among identical requests make the level
/// not ok.
#[test]
