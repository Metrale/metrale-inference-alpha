...
# 2026-09-26: Prefill floor: fixed cost per prefill forward, fitted from single-stream request walls.
#
...
# 2026-09-26: Targets only. The fit's x-axis is the server's usage.prompt_tokens.
...
def prompt_of(target_tokens, tag):
    # 2026-09-26: A random 12-letter head per request, so the prefix cache cannot
    # serve the body.
...
if __name__ == "__main__":
    ...
    # 2026-09-26: Least-squares fit wall = floor + tokens/throughput.
    n = len(pts)
