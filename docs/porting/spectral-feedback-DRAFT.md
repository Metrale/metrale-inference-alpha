...
Thread: Metrale Engine ↔ Spectral (Michael Søndergaard / Chris Kitching / Jon).
Context: first SCALE bring-up of Metrale Engine (pure-Rust CUDA LLM engine) on
...
**SCALE 1.7.0** targeting **gfx1151**, **82 of 92** of Metrale Engine's hand-written
...
This is our biggest lever — Metrale Engine's quantized GEMM/MoE hot path has ~200
...
helper — likely a smaller fix than (1). Several Metrale Engine kernels use the PTX
form directly.
...
**Bigger architectural question (the one that gates our runtime):** Metrale Engine
...
symbol? This is the last thing between us and running Metrale Engine on Strix Halo —
