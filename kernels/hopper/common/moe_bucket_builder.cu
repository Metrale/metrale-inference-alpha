...
#include <cassert>
// 2026-09-25: E<=256; exact ordered M128 large / M16 small lists, threshold on device.
extern "C" __global__ void bucket_builder(
 ...
 if(t==0){
  ...
  // 2026-09-25: A sparse one-warp bucket pays its long-K latency without enough CTAs to
