...
# 2026-09-26: Two-token model of sampling divergence at temperature T: intrinsic, cross-engine and excess.
#
...
For a 2-token decision with gap g (vLLM) and g+delta (metrale):
  intrinsic  = 1 - sum pv_i^2          (vLLM self-collision complement)
  cross      = 1 - sum pv_i * pa_i     (vLLM-vs-metrale)
