...
impl Qwen3SsmLayer {
    ...
    pub(super) fn prefill_inner_hc(
        ...
        // prefill, so `METRALE_GDN_DUMP` still attributes an intermediate to the
        // right layer.
        let ssm_layer_idx =
            super::debug::SSM_LAYER_CALL_COUNTER.fetch_add(1, std::sync::atomic::Ordering::Relaxed);

        // Stage profiler, the prefill twin of METRALE_QWEN4EXP_DECODE_PROF:
        ...
        // METRALE_FP32_ROUTING has the SSM's fused `residual_add_rms_norm_gatef32`
