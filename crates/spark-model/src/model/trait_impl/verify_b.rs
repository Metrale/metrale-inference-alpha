...
impl TransformerModel {
    pub(super) fn decode_verify_graphed_dispatch(
        ...
        // METRALE_K2_DIAG=1 arms per-stage synchronize checkpoints inside
        ...
        // (mirrors METRALE_DFLASH_DEBUG_NO_GRAPH for the DFlash verify path).
        ...
        // `METRALE_GLM_VERIFY_GRAPHS=0` to fall back to eager. Worth ~5 % at K=2
        ...
        //
        // 🪤 This deliberately does NOT read `METRALE_EP_GRAPHS`. That variable is set by the
        ...
        if need_run {
            ...
            if use_graphs {
                ...
                if graph.0 != 0 {
                    ...
                    // BISECT HATCH (METRALE_GLM_VERIFY_GRAPH_NOCACHE=1): capture-and-run every
