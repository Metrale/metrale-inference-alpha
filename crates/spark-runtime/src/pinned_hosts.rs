...
//!
//! Almost every `copy_h2d_async` call site in Metrale Engine hands over a stack array or
...
//! allocation Metrale Engine makes is recorded here; the CUDA backend consults it on the
