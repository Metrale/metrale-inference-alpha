...
impl BlockDiffusionDraftHead {
    pub fn from_weights(
        ...
        // 1 bonus). Block size 16 matches the rest of Metrale Engine.
        let block_size = 16;
        ...
        // against existing Metrale Engine resolutions in `qwen3_attention/mod.rs` and
        ...
        let kernels = DflashKernels {
            ...
            // (`out = x * w / RMS(x)`), NOT Metrale Engine's default offset-from-1
            // form (`out = x * (1 + w) / RMS(x)`). Metrale Engine's standard
            ...
            // a single launch. Metrale Engine exposes this as a separate kernel — see
            ...
            // `config.json:rope_scaling.rope_type="yarn"`. Metrale Engine's yarn
            ...
            // Phase G — Row-scaled BF16 × FP8 → BF16 GEMM. Metrale Engine custom
        ...
        // on prompts past a tiny window — Metrale Engine's 6-10% acceptance vs the
        ...
        // METRALE_DFLASH_CTX_WINDOW overrides at construction time.
        //
        ...
        //
        // Historical bug (Friday/Metrale 2026-05): this loader unconditionally
        ...
        let mut head = Self {
            ...
            layers: weights
                ...
                .map(|l| DflashLayer {
                    ...
                    // Phase G — populated below if METRALE_DFLASH_DRAFTER_FP8=1.
                    q_proj_fp8: None,
                    k_proj_fp8: None,
                    v_proj_fp8: None,
                    o_proj_fp8: None,
