...
//!   bytes only for checkpoints Metrale Engine loads verbatim; a BF16 checkpoint
...
///
/// Lever: `METRALE_KV_FLOOR_TOKENS=<n>` (0 disables the floor entirely).
pub(super) const DEFAULT_KV_FLOOR_TOKENS: usize = 4096;

/// `METRALE_KV_FLOOR_TOKENS`, or [`DEFAULT_KV_FLOOR_TOKENS`].
///
