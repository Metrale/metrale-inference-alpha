...
# 2026-09-26: CPU forward of the HF BF16 checkpoint; writes per-layer last-token hidden states.
#
...
last-token hidden states to /workspace/metrale-dumps/fp8native_dgx2/hf_bf16_L{0..39}.bin.
"""
