...
//!
//! Only the functions Metrale Engine actually calls are bound here — no attempt
...
unsafe extern "C" {
    ...
    //
    // For Metrale Engine's 2-rank Spark over RoCE, the copy-engine path doesn't
...
/// and the device-side communication API. On Metrale Engine's 2-rank Spark over
