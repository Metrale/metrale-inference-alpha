...
//! 2026-09-25: Pre-sampling EOS mask for the request `min_tokens` floor.
//!
//! Owner: scheduler.
...
/// 2026-09-25: Mask EOS ids while the effective output length is below `min_tokens`.
...
/// 2026-09-25: Pipeline stage: applies the mask with an effective length of
/// `output_tokens.len() + ctx.verify_pos`.
