...
",
        ...
        // line 53). Metrale Engine's expanded IMMEDIATE_TOOL_USE + 10-bullet IMPORTANT
        // diverges from that trained distribution and correlates with
        // malformed tool calls (empty {filePath,content} scaffolds, mixed
        // <function_calls> tags). METRALE_OFFICIAL_TOOL_PROMPT=1 swaps in the
        // verbatim official 4-bullet reminder. Default = current Metrale Engine block.
...
- If there is no function call available, answer the question with your current knowledge and do not tell the user about function calls.\n\
    ...
    fn leak_markers(&self) -> LeakMarkers {
        ...
        //
        // `<tool_response>` is a SERVER-internal wrapper that Metrale Engine renders
