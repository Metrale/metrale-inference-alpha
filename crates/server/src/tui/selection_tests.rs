...
//! 2026-09-26: Tests of `Selection` (click versus drag, ordering, containment)
//! and of `extract` over a hand-filled buffer.
//!
//! Owner: server tui.
...
fn a_multi_line_selection_wraps_like_a_text_editor() {
    // 2026-09-26: The first line runs to the right edge, middle lines are
    // whole, and the last line starts at the left edge.
    let s = Selection {
        anchor: (4, 1),
        cursor: (2, 3),
    };
...
fn extract_keeps_a_blank_line_between_content() {
    // 2026-09-26: A blank line inside the selection is kept; only trailing
