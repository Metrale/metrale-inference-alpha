...
// 2026-09-26: attention_finalize: output = o_state / l_state as bf16, 0 where l_state is not
// positive. `TiledAttention::finalize` launches it, the last call of a decode step
// (crates/storage/src/tiled_attention.rs).
//
// Layout:
