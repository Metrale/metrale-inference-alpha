#!/usr/bin/env python3
"""Fire the canonical 10382-token prompt at the dgx2 Metrale Engine op-drift server
to trigger METRALE_OP_DUMP / METRALE_GDN_DUMP / METRALE_NEMO_DUMP.

We send the *token IDs* directly via /v1/completions `prompt` field (Metrale Engine
