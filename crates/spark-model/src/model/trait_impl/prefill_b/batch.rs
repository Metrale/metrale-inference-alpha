...
impl TransformerModel {
    ...
    pub(in crate::model) fn prefill_batch_chunk_dispatch(
        ...
        // METRALE_NO_PREFILL_ROW_SHIFT=1 to put prefill back on rows
        ...
        // promote with `RUST_LOG=metrale::q12=debug`.
        tracing::debug!(
            target: "metrale::q12",
            n = n,
        ...
        //
        // Runtime kill switch: set `METRALE_Q12_BATCHED=0` to force-disable
