...
impl Qwen3AttentionLayer {
    pub(in crate::layers::qwen3_attention) fn prefill_attention_paged(
        ...
        //   - METRALE_FUSED_KV=1  (opt-in during dev; expected default later)
        ...
        if let Some(bmeta) = batched_meta {
            ...
            // (METRALE_FLASHINFER_PREFILL=1): the fresh contiguous, post-RoPE
        ...
        // METRALE_OP_DUMP: attn_out BEFORE sigmoid gate (raw attention-kernel output).
