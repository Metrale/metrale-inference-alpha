<!--
  The ambient Metrale Engine chevron field: one fullscreen triangle, one fragment
...
<script>
  ...
  /* Design tokens come from web-shared/metrale-tokens.css. Reading them from the
