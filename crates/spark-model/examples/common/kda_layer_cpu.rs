...
/// what BOTH Metrale Engine conv paths produce. V is left alone.
...
/// Every observable stage, on the host, in fp32 values that carry Metrale Engine's exact bf16 ladder.
