...
pub(super) fn build_dense_ffn(
    ...
    // Precision lever, mirroring `METRALE_NVFP4_MLA=0` on the attention side.
...
/// `METRALE_LONGCAT_BF16_FFN=1` keeps the per-sublayer dense FFN in BF16.
...
/// `METRALE_LONGCAT_FP8_EXPERTS=1` runtime-quantizes the routed experts to
