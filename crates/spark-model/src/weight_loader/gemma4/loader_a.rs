...
///
/// `METRALE_GEMMA4_FFN_TRANSPOSE=0` forces the fallback — an A/B lever, and an
...
pub(super) fn load_layers_impl(
    ...
    for i in 0..config.num_hidden_layers {
        ...
        // Attention quantization choice for Gemma-4. Metrale Engine's runtime
        ...
        // a a a a..."). Bisected via METRALE_DIAG_GEMMA4=1 logits dump.
        //
        ...
        //
        // Override via METRALE_GEMMA4_BF16_ATTN=0 to force NVFP4 for A/B
        // testing; METRALE_GEMMA4_BF16_ATTN=1 to force BF16 even on MoE.
        ...
        // wired for future bisection (`METRALE_GEMMA4_BF16_MLP=1`
        ...
        // ALL self_attn projections (q/k/v/o) stay BF16. Metrale Engine
        ...
        // Metrale Engine previously only allocated this for K=V (full-attention)
