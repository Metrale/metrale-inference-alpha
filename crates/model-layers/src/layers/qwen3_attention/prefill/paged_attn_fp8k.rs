...
//! 2026-09-25: The paged prefill attention arms for the FP8-K / turbo-V
//! dtypes (`Fp8KTurbo3V`, `Fp8KTurbo4V`, `Fp8KTurbo2V`). Each passes the FP8 K
//! scale and the V side's block stride to its kernel; any other dtype panics.
//!
