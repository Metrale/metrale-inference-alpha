...
//! ## Scope
//!
//! Metrale Engine's residual stream lives on the GPU; exposing it for a
...
//! READ-ONLY side signal (`x-metrale-confidence` SSE channel) that
...
/// `x-metrale-confidence` SSE channel.
#[derive(Debug, Clone)]
