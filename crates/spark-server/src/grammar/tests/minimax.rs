...
/// `xgrammar/tests/test_utils.rs:126` against a Metrale-compiled
...
///
/// Validates the canonical accept matrix:
...
/// (Metrale Engine bug). This unit test pins down which.
#[test]
...
fn test_minimax_xml_grammar_masks_trigger_breaking_multibyte_token() {
    ...
    if state.is_token_allowed(131) {
        ...
        // Metrale Engine applies a runtime backstop (F70) at the prompt /
