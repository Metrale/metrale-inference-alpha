...
# 2026-09-26: Scans a byte-level BPE vocabulary for whitespace-bearing tokens in three groups; writes JSON.
#
...
OUT_PATH = '/workspace/metrale-mtp/bench/fp8_dgx2_drift/qwen36_whitespace_tokens.json'
