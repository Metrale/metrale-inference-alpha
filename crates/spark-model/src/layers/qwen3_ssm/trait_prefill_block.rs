...
impl Qwen3SsmLayer {
    ...
    pub(super) fn prefill_block(
        ...
        // METRALE_GDN_DUMP hook #0c: post-qkvz GEMM (deinterleaved input
        ...
        // METRALE_SSM_TAIL_MIDCHUNK is active for a pass that spans `tb`.
        ...
        // METRALE_GDN_DUMP hook #1: post-conv1d (post-silu, applied inside
        ...
        // METRALE_GDN_DUMP hook #2: post-L2 norm on q,k (v unchanged).
        ...
        // METRALE_GDN_DUMP hook #3: post-GDN recurrence (pre-gnorm,
        ...
        // METRALE_GDN_DUMP hook #4: post-gated-RMSNorm. Downstream
        ...
        // METRALE_GDN_DUMP hook: SSM out_proj output — drift attribution.
        super::debug::maybe_dump_gdn_buf(
            ctx.gpu,
            out_proj_buf,
            (num_tokens - 1) * h * bf16,
