...
//! 2026-09-26: Tests for the campaign state machine in `state.rs`, which
...
fn a_clean_campaign_runs_every_unit_in_order_and_exits_zero() {
    ...
    // 2026-09-26: A clean run is still exit 2 when the final gate check does not certify.
...
/// 2026-09-26: Negative control: a non-retryable harness failure and a
/// timeout are not retried.
#[test]
...
/// 2026-09-26: Negative control: a guard that cannot answer aborts.
#[test]
