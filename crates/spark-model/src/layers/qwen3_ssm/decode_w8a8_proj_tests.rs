...
//! Which `METRALE_CUBLAS_GEMM` families arm the SSM decode W8A8 arm, and over
...
/// `METRALE_CUBLAS_GEMM=ffn` reaching the SSM projections is the #917 failure
...
/// `METRALE_NO_W8A8_DECODE_PROJ` wins over an armed family, at every rung.
#[test]
