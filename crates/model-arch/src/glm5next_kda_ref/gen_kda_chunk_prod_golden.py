...
# 2026-09-25: Writes the KDA chunked-prefill golden (kda_chunk_prod_golden.json) at H=64, D=128.
#
# Owner: model-arch (GLM-5.3-Flash KDA reference).
# Invariants:
# - Writes only /w/kda_chunk_prod_golden.json.
...
# 2026-09-25: The GPU chunk kernels read q/k already L2-normalised (by l2_norm_bf16 on prefill),
# so the golden runs with use_qk_l2norm_in_kernel=False on normalised tensors.
qn, kn = l2(q), l2(k)
...
# 2026-09-25: The distance between the chunked and recurrent runs on this fixture, recorded in
# hf_self_checks; the chunk microtest prints it.
