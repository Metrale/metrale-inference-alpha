...
# 2026-09-26: Concurrency sweep (C = 1, 1, 2, 4, 8) of non-streaming requests on
# port 8890: aggregate and per-request tok/s per level.
#
# Owner: bench.
...
# 2026-09-26: Appends "tokens elapsed_ms" for one request to the given file.
run_one() {
