...
// 2026-09-25: Kernels `attn_prefill_paged_fp8k_turbo4v` and `_64`: paged prefill flash attention with an FP8 E4M3 K
// cache and a turbo4 V cache.
//
...
// attn_prefill_paged_bf16k_turbo4v.cu's (arguments `tq4_v_bsb`, `tq4_v_dsb`).
//
// Owner: gb10 kernels.
...
#define KERNEL_NAME attn_prefill_paged_fp8k_turbo4v
