...
use metrale_core::mxfp4_e8m0::{dequant_nvfp4_e8m0_to_bf16, dequant_nvfp4_e8m0_to_f32};
...
mod tests {
    use super::*;
    use crate::kimi_k3_host::cpu_weights::K3CpuModel;
    use metrale_core::numeric::f32_to_bf16;
    ...
    fn synthetic_packed_round_trips_dsv4_e8m0() {
        ...
        let n = 1;
        let k = metrale_core::mxfp4_e8m0::GROUP_SIZE;
    ...
    fn from_pretrained_allow_mxfp4_skips_s5_bail() {
        let this = format!(
            "{}::from_pretrained_allow_mxfp4_skips_s5_bail",
            module_path!()
                .split_once("::")
