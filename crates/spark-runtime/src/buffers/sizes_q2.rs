...
//! `METRALE_GGUF_NATIVE_Q2*` flag is set, so non-Q2 models pay nothing.
...
///
/// - `q2_dequant_scratch` (Tier-1, `METRALE_GGUF_NATIVE_Q2=1`): the widest
///   keep-packed projection expanded to BF16 (see [`q2_dequant_scratch_bytes`]).
/// - `q2_act_q8` (Tier-2 MMQ, `METRALE_GGUF_NATIVE_Q2_MMQ=1`): the q8_1 activation
