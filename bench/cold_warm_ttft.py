...
# 2026-09-26: Cold then warm TTFT per prompt length, for a prefix-caching A/B.
#
# Owner: bench.
...
def build_prompt(target_tokens, salt):
    # 2026-09-26: The salt differs per tag and length, so trials do not share a
    # cached prefix.
...
def main():
    ...
    # 2026-09-26: One short request first; if it fails, exit 2 before any trial.
