...
impl MoeLayer {
    ...
    pub(super) fn run_routed_grouped_gemm(
        ...
        if max_m_tiles > 0 {
            ...
            // (CUTLASS B is ColumnMajor = K-contiguous), NOT the Metrale Engine
            ...
            if ctx.levers.moe_grouped_cutlass && self.cutlass_grouped_host.is_some() {
                ...
                // (METRALE_HOLO_MOE_GROUPED_CUTLASS=1) ── one
                ...
                if self.experts_scale_kind == crate::weight_map::WeightQuantFormat::Mxfp4E8m0 {
                    ...
                    // ── FUSED FP4 gate_up (METRALE_HOLO_MOE_GATEUP_FP4) ──
        ...
        if max_m_tiles > 0 {
            ...
            // ── FP4 down (METRALE_HOLO_MOE_DOWN_FP4) ── single block-scaled FP4
            ...
            {
                // ── CUTLASS grouped NVFP4 down (METRALE_HOLO_MOE_GROUPED_CUTLASS
                //    + METRALE_HOLO_MOE_GROUPED_DOWN) ──
                ...
                if self.experts_scale_kind == crate::weight_map::WeightQuantFormat::Mxfp4E8m0 {
                    ...
                    // ── FP4 down (METRALE_HOLO_MOE_DOWN_FP4) over the SHARED down_ptrs_t
