...
// Metrale Engine native ternary Q2_0 decode GEMV — keep-packed W2A16 for M=1..8 decode.
//
...
// NVFP4/FP8. Activation is plain BF16 (weight-only quant), matching Metrale Engine's
