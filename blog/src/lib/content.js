...
export const SITE = 'https://blog.dev.metrale.ai';
export const MAIN_SITE = 'https://dev.metrale.ai';
export const DOCS_SITE = 'https://book.dev.metrale.ai';
...
export const blog = {
  name: 'Metrale Engine blog',
  kicker: 'blog.dev.metrale.ai',
  ...
  description:
    'Engineering notes from the Metrale Engine: CUDA kernels, quantisation, ' +
    'speculative decoding, and benchmarks you can reproduce.'
};

/**
 * The four chevron colours carry fixed meanings on dev.metrale.ai — violet
...
export const authors = {
  'thomas-braun': {
    name: 'Thomas Braun',
    initials: 'TB',
    role: 'Founder, Metrale Engine Cybersecurity',
    bio: 'Works on the Metrale Engine — kernels, scheduling, and the benchmarks that decide whether any of it was worth it.'
  },
  'ronald-stesiak': {
    name: 'Ronald R. Stesiak',
    initials: 'RS',
    role: 'Founding Engineer, Metrale Engine',
    bio: 'Tunes Metrale Engine for speed on real hardware, from CUDA kernels to the speculative-decode layer. Holds the single-Spark records this blog reports.'
  },
  'alexi-derkatsch': {
    name: 'Alexi Derkatsch',
    initials: 'AD',
    role: 'Systems Engineer, Metrale Engine',
