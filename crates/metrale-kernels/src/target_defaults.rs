...
pub struct TargetDefaults {
    ...
    /// per-sequence launches. It was `METRALE_SSM_BATCHED_RECURRENT=1` in an
    ...
    /// `METRALE_SSM_BA_GATES_HOPPER=0` is the A/B. Numbers:
    ...
    /// `METRALE_FP8_ACT_QUANT_HOPPER=0` is the A/B. Numbers:
