...
//! than from Metrale Engine's own LUT.
//!
...
//!   **C** quantisation/dequant floor — Metrale Engine's CUDA `dequant_nvfp4_to_bf16` vs the independent
...
//!   **D** GPU kernel residual — Metrale Engine `w4a16_gemm` vs A.
//!   **E** integrated FFN residual — the whole gate/up → clamp → silu·mul → down chain vs A.
//!
//!   MOE_PACKET_DIR=/home/msi1/metrale-scratch/moe-family \
