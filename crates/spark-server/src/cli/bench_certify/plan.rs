...
use metrale_plugin::gate::{self, GateStatus};
use metrale_plugin::hardware::limits::TimingLimits;
use metrale_plugin::hardware::policy::Sensitivity;
use metrale_plugin::registry;
...
pub enum Estimate {
    ...
    Declared(u64),
    /// The newest completed run in `~/.metrale/runs`.
