...
//! and the whole `METRALE_*` lever set the gate applied (`serve_env`).
//!
...
impl GateRecord {
    ...
    /// the inherited environment, so a declared `METRALE_PREFILL_CODISPATCH=1`
