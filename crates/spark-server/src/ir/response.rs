...
/// surface (prefix-cache hits, reasoning tokens) and Metrale Engine's
...
pub struct Usage {
    ...
    /// Metrale Engine's self-drafted MTP predictions are). 0 when speculation is off.
    pub accepted_prediction_tokens: usize,
    /// Metrale Engine perf extensions; encoders may ignore.
    ///
