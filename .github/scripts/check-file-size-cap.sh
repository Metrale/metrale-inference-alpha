...
allow_list=(
  ...
  "crates/metrale-plugin/src/benchmarks/video/driver.rs"
  "crates/metrale-plugin/src/benchmarks/vision/driver.rs"
  "crates/metrale-plugin/src/benchmarks/media_integrity.rs"
  ...
  "crates/metrale-kernels/build.rs"
  ...
  "crates/metrale-core/src/config/tests.rs"
  "crates/metrale-core/src/config.rs"
  ...
  "crates/metrale-core/src/config/parsers/glm5_next.rs"
...
while IFS= read -r -d '' file; do
  ...
  if [[ $lines -gt 500 ]]; then
    ...
    if [[ $allowed -eq 1 ]]; then
      ...
      echo "::error file=$normalized::$lines LoC exceeds 500-line cap. Split into sub-modules per Metrale Engine idiom (see crates/spark-model/src/layers/qwen3_attention/ for compute-heavy template, crates/spark-model/src/weight_loader/ for variant-dispatch template)."
