...
//! The `METRALE_*_M16_TC` LEVER GRAMMAR (#927, split in round 6) and the CTA-tile
...
/// THE POINT OF THE SPLIT: `METRALE_FFN_M16_TC` must no longer reach attention.
#[test]
...
/// the pair, and the umbrella that can set both (`METRALE_M16_TC`) is folded in
