...
use metrale_core::kimi_k3::{K3Graph, kda_from, mla_from, moe_from};
...
pub use metrale_core::kimi_k3::weights::{layer_keys, text_key};
...
fn dense_for_bf16_engine(
    ...
    anyhow::ensure!(
        metrale_core::kimi_k3::binding_memory::engine_bf16_weight(name),
