...
/* ============================================================
   Metrale Engine chevron field
   ------------------------------------------------------------
   A depth-stacked field of the Metrale Engine chevron, drifting slowly
...
uniform vec3  u_c1;         // --ch-violet, #9F8DD8
uniform vec3  u_c2;         // --ch-cyan,   #6FD9EC
uniform vec3  u_c3u;        // --ch-green,  #12B981
uniform vec3  u_c3l;        // --ch-gold,   #E4C070
uniform vec3  u_ground;     // --bg,        #0E1318
