...
use metrale_core::kimi_k3::{LayerCache, MlaConfig};
...
fn validate_mla_restore(
    current: &metrale_core::kimi_k3::MlaKv,
    restored: &metrale_core::kimi_k3::MlaKv,
...
mod tests {
    use super::*;
    use metrale_core::kimi_k3::{KdaConfig, KdaState};
    ...
    fn resident_mla_snapshot_restore_and_empty_restore() {
        use metrale_core::kimi_k3::{MlaConfig, MlaKv};
