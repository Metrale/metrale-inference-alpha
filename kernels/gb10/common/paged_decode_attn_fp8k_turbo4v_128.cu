...
// 2026-09-25: Paged decode attention over an FP8 E4M3 K pool and a Turbo4 V pool (4-bit indices
// into a 16-entry codebook, one FP8 E4M3 scale per 16 elements).
//
// Owner: gb10 kernels.
// Invariants:
...
// one k_scale. V block (stride v_block_stride_bytes): token-major head rows of head_dim / 2
...
// 2026-09-25: One lane's VEC_BF16 V elements from one uint32 (HDIM=256) or uint16
