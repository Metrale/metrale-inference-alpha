...
<svelte:head>
  <title>Not found — Metrale Engine</title>
  ...
  <meta
    name="description"
    content="That page is not here. Metrale Engine is a pure-Rust inference engine for DGX Spark and Strix Halo; the front page has the install command and the benchmarks."
  />
</svelte:head>
