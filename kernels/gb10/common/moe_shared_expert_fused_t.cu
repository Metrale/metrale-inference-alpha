...
// ARM-2 Phase-K RIDER 1: the E8M0 scale primitive (mx_block_scale / metrale_dec_e4m3)
...
// metrale_dec_e4m3 + mx_block_scale<E8M0> now live in mx_block_scale.cuh (RIDER 1).
