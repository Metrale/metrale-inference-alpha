...
// 2026-09-26: Metal kernels for NLLB-200: fp32 kernels from `nllb_embed` to `nllb_attention`,
// then bf16 kernels from `nllb_embed_bf16` on, including batched decode, argmax and top-k.
//
