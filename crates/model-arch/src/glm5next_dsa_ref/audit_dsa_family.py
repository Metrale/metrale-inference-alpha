...
# 2026-09-25: Audits the dtype and shape of every DSA attention tensor in the checkpoint
# snapshot, and extracts per-layer packets.
#
...
MTP = cfg["num_hidden_layers"]  # 2026-09-25: the MTP layer's index is num_hidden_layers
ALL = DSA + [MTP]
