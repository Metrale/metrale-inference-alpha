...
//!
//! Both halves are fixed in [`metrale_kernels::attn_splitk`]: the SM count is
...
/// `METRALE_ATTN_DBG`: the split structure this layer resolved, printed once per
...
/// preference:
///
/// 1. The lever is armed (`METRALE_ATTN_DECODE_GQA_PACK`, declared off —
