...
fn main() {
    ...
    // `metrale_scale` mirrors spark-runtime's build.rs cfg: it marks the SCALE/
    ...
    // `metrale_hip` is the strict subset of metrale_scale for the NATIVE-HIP target
    ...
    // there; on metrale_hip we skip predequant and use the NVFP4 (w4a16 WMMA)
