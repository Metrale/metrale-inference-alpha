...
//! 2026-09-25: Parity of the non-causal `attention_full` kernel.
//!
...
/// 2026-09-25: `attention_full` against an FP32 reference with no causal mask:
/// every query token attends to all 6 keys, with 4 query heads over 2 KV heads.
#[test]
