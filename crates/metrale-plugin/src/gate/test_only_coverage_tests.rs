...
fn test_looking_neighbours_remain_fail_closed() {
    for path in [
        "crates/metrale-core/src/config/tests.rs.bak",
        "crates/metrale-core/src/config/tests/tests_b.rs",
        "crates/metrale-core/src/config/gguf/not_really_tests.rs",
        "crates/metrale-core/src/config/gguf.rs",
        "crates/metrale-core/src/config.rs",
        "crates/metrale-plugin/src/benchmarks/concurrency_tests.rs.bak",
        "crates/metrale-plugin/src/benchmarks/concurrency_tests/helper.rs",
    ] {
