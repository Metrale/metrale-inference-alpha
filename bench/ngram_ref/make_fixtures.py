...
# 2026-09-26: Writes ngram_id_fixtures.json: expected n-gram ids per table for two token lists.
#
# Owner: bench, n-gram reference.
# Invariants: none beyond the types.
"""Emit cross-language n-gram id fixtures (consumed by the Rust unit test
in metrale-model-layers's ngram module). Run from bench/ngram_ref/."""
import json
...
for name, cfg, toks in [
    ...
    ("longcat_lite", Cfg(),  # 2026-09-26: Cfg() defaults are the LongCat-Lite dims
