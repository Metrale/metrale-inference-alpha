...
extern "C" int metrale_gdn_prefill_packed(void*,void*,void*,void*,void*,void*,void*,float,int,int,int,int,int,int,int,int,void*);
...
int main(){
  ...
  int ret=metrale_gdn_prefill_packed(dqkv,dgb,dout,dst,dini,dtm,dcu, 0.08838834764831843f, T,nk,nv,kd,vd,conv_dim,gb,1, s);
  ...
  printf("RESULT: %s\n",(cos>0.99&&nan==0&&so/n>1e-4)?"PASS - Metrale-native packed layout matches JIT reference":"MISMATCH");
  return 0;
}
