...
//! 2026-09-26: `ModelConfig::qwen3_next_80b_nvfp4`, a hard-coded Qwen3-Next-80B config. The
//! m2m_100, gemma4 and mistral parsers start from it and overwrite fields.
//!
//! Owner: config.
...
impl ModelConfig {
    pub fn qwen3_next_80b_nvfp4() -> Self {
        Self {
            ...
            rms_norm_eps: 1e-6,
            bos_token_id: 151643,
            glm5next_router_mode: crate::Glm5NextRouterMode::HfFp32,
            eos_token_id: 151645,
            // 2026-09-26: Empty means not populated; `eos_ids()` then falls back to the scalar.
            ...
            // 2026-09-26: 0.0 means no SwiGLU clamp. The glm5_next parser refuses a config
