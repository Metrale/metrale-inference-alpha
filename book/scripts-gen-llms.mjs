 ...
 * build output, so this lands at https://book.dev.metrale.ai/llms.txt.
 *
...
const SITE = 'https://book.dev.metrale.ai';
...
const body = `# The Metrale Engine Book

> Documentation for Metrale Engine — an open source, pure Rust and CUDA LLM inference
