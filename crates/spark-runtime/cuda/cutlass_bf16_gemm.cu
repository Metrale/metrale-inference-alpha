...
int metrale_cutlass_bf16_gemm_act_weight_t_impl(
    const void* act,
    const void* weight,
    void* out,
    int m,
...
extern "C" int metrale_cutlass_bf16_gemm_act_weight_t(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<128, 128, 32, 64, 64, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cutlass_bf16_gemm_act_weight_t_128x256(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<128, 256, 32, 64, 64, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cutlass_bf16_gemm_act_weight_t_256x128(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<256, 128, 32, 64, 64, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cutlass_bf16_gemm_act_weight_t_64x128(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<64, 128, 32, 32, 64, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cutlass_bf16_gemm_act_weight_t_128x64(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<128, 64, 32, 64, 32, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cutlass_bf16_gemm_act_weight_t_64x64(
    const void* act,
    const void* weight,
    void* out,
    int m,
    ...
    size_t workspace_size,
    cudaStream_t stream) {
  return metrale_cutlass_bf16_gemm_act_weight_t_impl<64, 64, 32, 32, 32, 32>(
      act, weight, out, m, n, k, workspace, workspace_size, stream);
}

extern "C" int metrale_cublaslt_bf16_gemm_act_weight_t_algo(
    const void* act,
    const void* weight,
    void* out,
    int m,
