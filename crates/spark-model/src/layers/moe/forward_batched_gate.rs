...
impl MoeLayer {
    ...
    pub(super) fn batched_gate_logits(
        ...
        // FP32 gate path (METRALE_FP32_GATE): keep the router GEMM accumulator in
        ...
        // METRALE_FP32_ROUTING: the SSM-side norm already wrote an FP32 router_in
        ...
        // gate-only METRALE_FP32_GATE (which keeps the BF16 router_in but f32 gate
        ...
        // Routing-divergence diagnostic (no-op unless METRALE_DUMP_EXPERT_IDS=1):
