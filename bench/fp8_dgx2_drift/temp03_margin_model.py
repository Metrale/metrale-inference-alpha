...
# Metrale Engine's gap at the same position (recompute below from raw dumps would be
...
def p_temp_div(g, T, n_mc=4000, rng=None):
    ...
    # divergence between the vLLM(g) and Metrale Engine(g+delta) 2-way softmaxes.
