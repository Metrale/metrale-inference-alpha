...
`3rdparty_patches/gdn_aot/libmetralegdn.so` at runtime, on a config claiming
...
| swapping `libmetralegdn.so` | **nothing** | **all 5** |
...
NONE  bfcl-subset — latest record is for fe99349724 (2026-08-08-fe99349724.json)
      — invalidated by crates/metrale-kernels/tests/kernel_arity.rs,
