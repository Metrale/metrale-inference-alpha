...
// Localized on hardware via METRALE_K4_DIAG=1: "CUDA error after GDN phase
...
/// NOT behind `METRALE_FFN_BATCH16` — that opt-in governs only the dense-FFN
...
/// The kill switch (`METRALE_NO_QKVZ_NVFP4_DECODE`) restores the FP8 choice at
