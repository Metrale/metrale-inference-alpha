...
//
// This module is split per the Metrale Engine SDD file-size idiom:
...
// The peer's residency IS `metrale_tier::Residency` and its verbs ARE
// `metrale_rdma::verbs`, imported directly — nothing tier- or verbs-shaped is
// hand-rolled here.

// The RW-blade handshake codec lives verbatim in the CUDA-free `metrale-rdma`
...
pub use metrale_rdma::wire::CacheServerParams;
...
// `crates/metrale-rdma/tests/wire_roundtrip.rs`; the exact byte layout stays
