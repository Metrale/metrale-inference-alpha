...
Metrale Engine EP (Expert Parallelism) filtering works by tensor name — it looks for
...
reorganised into per-expert tensors. Compatible with Metrale Engine's existing EP
...
def main():
    parser = argparse.ArgumentParser(
        description="Split Step 3.7 Flash NVFP4 fused expert tensors for Metrale Engine EP support"
    )
