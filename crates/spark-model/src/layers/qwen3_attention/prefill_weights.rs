...
impl Qwen3AttentionLayer {
    ...
    pub(crate) fn w4a16_gemm_m128_dispatch(
        ...
        // METRALE_W4A16_VARIANT: "v1"/"v2"/"v3" pin a kernel; 0 = auto (v2 — 3
        ...
        // Gated by METRALE_BF16_TC_PROJ (default off → unchanged). Removes the
    ...
    /// `METRALE_GGUF_NATIVE_Q2=1`). Decode dispatches `q2_0_gemv_vec` (2-bit
    ...
    pub(crate) fn q2_prefill_gemm(
        ...
        // Tier-2 native MMQ (METRALE_GGUF_NATIVE_Q2_MMQ=1): quantize `input` to q8_1
    ...
    pub fn predequant_for_prefill(
        ...
        // Under native NVFP4 prefill (METRALE_CUTLASS_NVFP4_GEMM=1) all of Q/K/V/O
