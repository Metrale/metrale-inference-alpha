# 2026-09-25: Byte accounting of every tensor in the GLM-5.3-Flash checkpoint index, by family,
# with the loaded text-model total and an EP=2 per-rank estimate.
#
...
# 2026-09-25: EP=2 estimate: the routed-expert bytes are halved and every other loaded family
# is counted on both ranks.
