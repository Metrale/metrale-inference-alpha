...
`/home/cluster/launch-metrale-ep4.sh` (`--tp-size 1 --ep-size 4 --world-size 4`).
...
`qwen3.5-35b-a3b/nvfp4/` (shared by `[sources] use` where the bytes agree, a
fork with a `forked-from:` header where they do not; never a symlink). Everything else
