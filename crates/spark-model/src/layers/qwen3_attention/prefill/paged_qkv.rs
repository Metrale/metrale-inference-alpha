...
impl Qwen3AttentionLayer {
    ...
    pub(super) fn prefill_attention_paged_qkv(
        ...
        // the Q, K and V GEMMs (same input). OPT-IN ONLY (METRALE_ATTN_W4A4=1):
        ...
        // METRALE_OP_DUMP hook: q_proj output (last token, BF16 → f32).
    ...
    fn prefill_one_proj(
            ...
            && self.w8a16_gemm_t_m128_k.0 != 0
        {
            ...
            // METRALE_FP8_DEQUANT_ATTN_TO_BF16=1, `dense` (= attn.{q,k,v}_proj)
        ...
        // Runs before the caller's METRALE_OP_DUMP, so dumps show ADAPTED
