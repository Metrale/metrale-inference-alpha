...
// 2026-09-25: Absorbed-MLA prefill attention for head dim 576: scalar BF16 dot products with FP32
...
// row and 36 dims per lane, so head_dim is at most 576. causal != 0 limits row t to keys 0..=t.
...
// 2026-09-25: The entry keeps the name mla_prefill_attn_320 that qwen3_attention/init.rs looks up;
// this fork's head dim is 576.
