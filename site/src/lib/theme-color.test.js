 ...
 *
 * A palette change that sweeps every stylesheet and misses an app.html leaves
 * the chrome a stale colour above the page; this holds them equal.
 */
...
test('the PWA manifest agrees with the page it frames', () => {
  ...
  // #0E1318 page. theme_color is the window chrome; background_color is the
