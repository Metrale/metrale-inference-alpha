...
//! `qwen38.metrale.a.lat.c1`). The shipped workaround was `--max-batch-size 4`
//! (cell `qwen38.metrale.c.lat.c1`, reserve 8.54 GiB, GO in 22 s): paying for
...
///
/// Kill switch: `METRALE_SSM_RESERVE_RING_FULL` present => restore the old
