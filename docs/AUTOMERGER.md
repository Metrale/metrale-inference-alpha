...
2026-09-04T23:00Z  tool       stack/perf-plumbing composed OFFLINE in .wt-perf (2 PRs, authorship preserved, clean cherry-picks); cargo check EXIT=0; metrale-core 128/128; spark-runtime 277/277; LoC cap ok — NOT pushed (CI conservation during runner starvation)
...
08:05Z  aggregate  the fix edits crates/metrale-plugin/src/benchmarks/bfcl/aggregate.rs, a measured input
...
excludes the whole `crates/metrale-plugin/src/gate` prefix, so a PR rewriting the
