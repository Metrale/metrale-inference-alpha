...
//! Metrale Engine #919 part 2: `usage.prompt_tokens_details.cached_tokens` accounting.
//! Logical child of `phase_promote_prefills` via `#[path]`.
/// Metrale Engine #919: `usage.prompt_tokens_details.cached_tokens` must report the
