#!/usr/bin/env python3
# 2026-09-26: For each case, generates turn 1 once, then sends the same turn-2
# conversation twice with greedy decoding and reports the first token where the two
# answers differ. Exits 1 if any case differs.
#
...
def run_case(name, u1, u2):
    ...
    # 2026-09-26: The first turn-2 send is the reference ("cold") and the second,
    # identical send the replay ("warm"); both follow the turn-1 send above.
