...
//! 2026-09-25: Geometry checks for the Kimi K3 resident KDA state and its
//! snapshots, on the mock GPU backend.
//!
...
use metrale_model_arch::kimi_k3::{
    K3CpuFallbackState, K3KdaDecodeKernels, KdaDeviceState, launch_k3_kda_decode_token_on_device,
};
use metrale_model_weights::kimi_k3_host::{KdaConfig, KdaState, LayerCache};
