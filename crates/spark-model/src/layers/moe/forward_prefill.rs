...
impl MoeLayer {
    ...
    pub fn forward_prefill(
        ...
        // ALL token counts on metrale_hip. SCALE keeps grouped (its symlinked
        ...
        // so long FP8 prefills (>64 tokens) take the grouped path on metrale_hip too
        ...
        if let Some(fp8) = self.gate_fp8 {
            ...
            // must stay on the scalar kernel and why METRALE_CUBLAS_GEMM must
        ...
        // delta is installed (METRALE_LORA_EXPERTS=1).
