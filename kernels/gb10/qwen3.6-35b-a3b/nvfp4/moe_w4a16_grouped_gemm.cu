...
// Metrale Engine Grouped W4A16 GEMM for MoE — 35B model shadow.
//
...
// METRALE_NO_WARP_BLOCKSCALE_MMA, because its instruction selection does not
...
// and NOWHERE ELSE Metrale Engine targets:
//
...
// (METRALE_HOLO_MOE_GATEUP_FP4 / _DOWN_FP4), so their absence costs the FP4
...
//    scale (mirrors metrale_cutlass_pack_bf16_act_nvfp4: scale=max_abs/6).
...
// (`METRALE_HOLO_MOE_DOWN_FP4`). One Blackwell block-scaled FP4 MMA per k64
