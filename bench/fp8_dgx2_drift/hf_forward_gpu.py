...
# 2026-09-26: GPU forward of one HF checkpoint (bf16 or fp8-dequantised); writes per-layer last-token hidden states.
#
...
forwards the 10382-token prompt from /tmp/metrale_tokens_dgx2.json, dumps
per-layer LAST-token hidden states to /workspace/metrale-dumps/fp8native_dgx2/.
