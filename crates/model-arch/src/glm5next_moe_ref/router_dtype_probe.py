# 2026-09-25: Compares FP32 and BF16 router routing on synthetic LCG inputs for the layer 3, 23
# and 44 router packets: logit difference, top-8 set disagreement and moved routed weight.
#
...
for LAYER in (3, 23, 44):
    ...
    for T in (1, 64, 2048):
        ...
        # 2026-09-25: Share of the FP32 ladder's routed weight on experts the BF16 ladder
        # did not pick.
        moved = []
        for r in range(T):
            common = s32[r] & sbf[r]
