...
//!
//! Metrale Engine serves an OpenAI-compatible API; every mainstream client library
...
//! them. (If an enterprise customer needs mTLS in front of Metrale Engine, the
//! standard answer is a reverse proxy — nginx, Envoy, Caddy — terminating
//! TLS and forwarding to Metrale Engine on localhost.)
//!
