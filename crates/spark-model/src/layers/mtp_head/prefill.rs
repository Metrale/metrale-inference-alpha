...
//! Batched MTP drafter context prefill (METRALE_MTP_DRAFTER_PREFILL).
//!
...
impl MtpHead {
    ...
    /// the catch-up feed (METRALE_MTP_CATCHUP) appends at `row_base = seq_len`
    ...
    pub(crate) fn drafter_rows_impl(
        ...
        // METRALE_MTP_PREFILL_PROFILE=1: per-phase wall clock for this pass, so the
