...
//
// METRALE FFN prefill GEMM via vendored llama.cpp Q4_K MMQ (verified 56 TFLOP/s, 1.3x faith2).
...
// bf16-input variant (Metrale Engine activations are bf16) — avoids a bf16->f32 cast + scratch.
