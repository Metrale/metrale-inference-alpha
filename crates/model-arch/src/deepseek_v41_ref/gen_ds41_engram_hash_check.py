...
# 2026-09-25: Recompute the engram hash parameters through the reference's
# engram.py and compare them with the Q2_K GGUF's deepseek41.engram.* metadata.
# Needs the reference checkout and the GGUF at the paths in REF / GGUF.
#
...
`deepseek41.engram.*` metadata in the vcruz305 Q2_K shard 0. No model forward, no GPU.
  ...
  python3 crates/model-arch/src/deepseek_v41_ref/gen_ds41_engram_hash_check.py
"""
import struct
import sys
import time
