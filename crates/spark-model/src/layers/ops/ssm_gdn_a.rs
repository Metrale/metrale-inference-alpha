...
/// FP16 h-state twin of [`gdn_decode_f32_strided_norm`] (`METRALE_SSM_H_FP16`).
///
...
/// (`METRALE_SSM_H_FP16`). `n` is the FP32 ELEMENT count, derived from the
...
/// (`METRALE_SSM_H_FP16`). `n` is the FP32 ELEMENT count of the destination.
///
