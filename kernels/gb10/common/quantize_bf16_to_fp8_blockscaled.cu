...
// with no calibration metadata (LongCat-Flash-Lite is the first). Metrale Engine's only
...
// multiples of 128, though every shape Metrale Engine feeds this today is.
//
