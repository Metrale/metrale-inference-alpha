...
# 2026-09-26: Writes a sliced LongCat checkpoint (first N layers, golden-seeded embedding) for backbone parity.
#
...
fused = gold['input'].astype(np.float32)
...
# 2026-09-26: Synthetic embedding: zeros except the fixture tokens' rows, which hold
# the golden fused embeddings.
...
# 2026-09-26: Config: the sliced layer count, and the three n-gram keys removed.
c = dict(cfg)
