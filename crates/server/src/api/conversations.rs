...
//! 2026-09-26: `/v1/conversations` handlers over the process-wide
//! `conversation_store`.
//!
...
/// 2026-09-26: The public JSON shape of a conversation snapshot.
...
/// 2026-09-26: POST /v1/conversations: create a conversation with optional
/// initial items (at most `MAX_ITEMS_PER_INSERT`) and metadata.
pub async fn create_conversation(
    ...
    let Json(req) = match req {
        Ok(r) => r,
        Err(_) => {
            // 2026-09-26: A missing or unparsable body creates an empty
            // conversation.
...
/// 2026-09-26: GET /v1/conversations/{id}
...
/// 2026-09-26: POST /v1/conversations/{id}: update metadata.
...
/// 2026-09-26: DELETE /v1/conversations/{id}
...
/// 2026-09-26: POST /v1/conversations/{id}/items: append items, at most
/// `MAX_ITEMS_PER_INSERT` per call.
...
/// 2026-09-26: GET /v1/conversations/{id}/items: `order=desc` reverses the
/// items, then `limit` (default 20, at most 100) keeps the first ones.
...
/// 2026-09-26: GET /v1/conversations/{id}/items/{item_id}
...
/// 2026-09-26: DELETE /v1/conversations/{id}/items/{item_id}
