...
// — 196 — had to be dug out of `target/release/build/metrale-kernels-*/output`
...
/// `metrale-kernels: <N> kernels (<hw>, <model>, <quant>), <M> model-dir kernels, <K> declared overrides`
///
...
/// `build_defaults::read_defaults` — this also runs on the `METRALE_SKIP_BUILD`
