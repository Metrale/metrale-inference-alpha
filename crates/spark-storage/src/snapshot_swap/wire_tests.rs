...
//! reserved-slot pinning, overwrite/remove, size laws) moved to metrale-tier
...
/// exactly what a RAW one-sided KV client (METRALE_KV_PAGING off) and the bounded/unified
