...
[Metrale Engine](https://github.com/Metrale/metrale-inference-alpha), WebGPU, Rust and 100%
...
- A "how it works" section describing the Metrale Engine → WebAssembly → WebGPU → editor pipeline.
- A footer linking to the Metrale Engine repository, site, Discord and licence.
...
AGPL-3.0-only, matching Metrale Engine. Source files carry an SPDX header.
