...
//! consolidation, DEFAULT-OFF behind `METRALE_KV_PAGING`).
//!
...
//! record `metrale_tier::Residency` demands, one contiguous blob at one pointer
...
//!
//! FLAG OFF (`METRALE_KV_PAGING` unset/0) the selection helper returns the raw
