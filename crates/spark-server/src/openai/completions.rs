...
pub struct CompletionRequest {
    ...
    /// Metrale Engine accepts up to 20 (clamped), matching the chat endpoint.
    ...
    /// Accepted for OpenAI compatibility; not used by Metrale Engine (no abuse
...
pub struct CompletionResponse {
    ...
    pub usage: Usage,
    /// Matches chat completions ("fp_metrale"); some SDKs read it for
