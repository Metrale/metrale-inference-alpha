...
//! 2026-09-26: CPU parity and RST known-bad mutants for `kda_decode.cu`. Compiles
//! under METRALE_SKIP_BUILD. The CUDA launch is `metrale_model_arch::kimi_k3::kda_cuda`.
...
/// 2026-09-26: CPU copy of the loop nest (V outer, K inner) of `k3_kda_recurrent_step_f32`.
