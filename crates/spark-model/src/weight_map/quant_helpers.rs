...
/// time for FP8-MoE models under METRALE_FP8_DEQUANT_MOE_TO_BF16=1 (~30k calls,
...
/// to BF16 because Metrale Engine dense kernels consume BF16.
...
/// as the reciprocal of Metrale/TRT-LLM's `scale2`. Verified empirically:
///   - nvidia 80B `weight_scale_2` ≈ 7.01e-5 (small)
///   - Sehyo 35B `weight_global_scale` = 29568 → `1/29568` ≈ 3.38e-5 (same order)
///
/// Metrale Engine GEMV dequant: `w = E2M1_val * fp8_scale * scale2` requires the small value.
