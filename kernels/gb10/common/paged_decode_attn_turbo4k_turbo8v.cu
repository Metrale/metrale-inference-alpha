...
// 2026-09-25: Paged decode attention over a Turbo4 K pool (4-bit indices, 16-entry codebook, one
...
//
// Rows are token-major: head_dim / 2 bytes (K) or head_dim bytes (V) per head, then from the
