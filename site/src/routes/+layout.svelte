<script>
  ...
  import '../app.css';
  // The fallback faces the brand type swaps in over; the faces themselves are
  // attached after first paint by src/app.html (static/fonts/type.css).
  ...
  import { tagline, hero, faq, githubUrl, recipesUrl, discordUrl } from '$lib/data.js';
    ...
    '@graph': [
      {
        ...
        description: tagline,
        sameAs: [githubUrl, recipesUrl, discordUrl]
      },
      {
        '@type': 'WebSite',
        '@id': `${SITE}#site`,
