...
# 2026-09-25: Writes the NoPE MLA golden (dsa_mla_golden.json) from the transformers
# glm5_next attention on real layer weights.
#
...
# 2026-09-25: S=2176 gives 544 pools against select_k = 2048 / 4 = 512, so 32 pools are left out
# and the attention is sparse.
