...
//! # The fix
//!
//! Two halves, both behind `METRALE_NO_MTP_EAGER_DRAFTER` (PRESENCE):
//!
...
/// `METRALE_NO_MTP_EAGER_DRAFTER` (PRESENCE): restore the propose-site-only
...
impl TransformerModel {
    /// METRALE_MTP_DRAFTER_PREFILL: copy this prefill chunk's final-layer
    ...
    pub(super) fn try_mtp_prefill_capture_from(
        ...
        // METRALE_MTP_CARRY_DRAFTER: a warm turn's chunk starts at the reused-
