...
// forked-from: kernels/gb10/common/gated_delta_rule.cu (2026-09-24; 1878 of 1580 lines differ, see kernels/FORKS.md)

// 2026-09-25: Gated delta rule (GDN) kernels for qwen3-next-80b-a3b, also compiled for qwen3.5-27b
// through its [sources] use: prefill with each thread's state column in registers (plain, split,
// split4 and batched split4), single-token decode, two- and three-token steps, and fused decode forms.
//
// Owner: gb10 kernels (qwen3-next-80b-a3b).
// Invariants:
