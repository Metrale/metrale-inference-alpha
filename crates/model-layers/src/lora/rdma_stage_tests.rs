...
//! 2026-09-25: Tests for `rdma_stage`: landing targets from a manifest, their
//! refusals, and the pair rebuild after landing.
//!
//! Owner: model-layers (lora).
//! Invariants: none beyond the types.

use super::*;
use metrale_storage::weight_peer::{WeightManifest, WeightTensorRecord};
