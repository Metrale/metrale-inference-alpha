...
/// launches it: `[defaults] gdn_prefill_tc`, with `METRALE_GDN_PREFILL_TC`
...
/// `METRALE_GDN_PREFILL_TC=0` is what silences it again.
///
...
/// byte-identical on the ssm-poisoning tripwire. `METRALE_GDN_VTILE=1` swaps in
