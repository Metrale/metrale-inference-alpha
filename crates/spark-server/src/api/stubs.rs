...
/// GET /v1/batches/{id} — Metrale Engine has no batch store.
...
/// POST/GET/DELETE /v1/files* — Metrale Engine has no file-upload store.
...
/// POST /v1/audio/* — Metrale Engine has no ASR/TTS model loaded.
...
/// POST /v1/images/* — Metrale Engine has no image-generation model loaded.
...
/// POST /v1/moderations — Metrale Engine does not run a safety-classifier model.
