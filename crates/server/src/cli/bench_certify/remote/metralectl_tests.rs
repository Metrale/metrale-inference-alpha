...
fn a_node_row_parses_into_the_facts_the_driver_reads() {
    ...
    // 2026-09-26: An error row, and an unknown extra field, both parse.
    ...
    // 2026-09-26: A node with no thermal block at all: the field is None, not a parse error.
    let bare: NodeRow =
