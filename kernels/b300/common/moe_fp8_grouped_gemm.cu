...
// Metrale Engine FP8 Grouped MoE GEMM — Sorted expert dispatch with FP8 E4M3 block-scaled weights.
//
...
// load-time CPU dequant in `metrale_core::numeric::f32_to_bf16` (the one
