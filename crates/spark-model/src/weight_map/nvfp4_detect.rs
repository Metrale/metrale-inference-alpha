...
pub fn config_declared_variant(config: &metrale_core::config::ModelConfig) -> Option<Nvfp4Variant> {
...
pub fn detect_nvfp4_variant(
    ...
    // projections Metrale Engine actually consumes. If we claim Standard here the
