...
for L in LAYERS:
    ...
    # Metrale Engine side feeds exactly these values, so the two sides start from an identical tensor.
    ...
    # prefix and cannot be regenerated from an LCG on the Metrale Engine side, and an input read from a
