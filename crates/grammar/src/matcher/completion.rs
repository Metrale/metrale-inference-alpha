...
//
// Powers budget-aware graceful close of structured outputs (Metrale Engine #144):
...
//
// There is no C++ upstream for this; it is a Metrale Engine addition built on the
