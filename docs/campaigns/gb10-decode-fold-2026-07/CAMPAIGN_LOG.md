...
Build: `cd <worktree> && PATH=/usr/local/cuda/bin:$PATH METRALE_TARGET_HW=gb10 METRALE_TARGET_MODEL=qwen3.6-27b cargo build --release -p spark-server --bin met --features cuda`
