# 2026-09-26: Sums a snapshot's shard file sizes by file-name family (local files, or
# the Hub's size header for shards not on disk) and prints the resident total without
# the PLE tables.
#
...
The resident-vs-deferred split is the number the single-DGX-Spark decision rests
...
def remote_size(name):
    ...
    req = urllib.request.Request(url, method='HEAD',
                                 headers={'User-Agent': 'metrale-sizing'})
