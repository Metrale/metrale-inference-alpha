...
#
# MUST EXCEED THE MARCONI CHECKPOINT INTERVAL. Metrale Engine writes an intermediate SSM
...
# STREAM=1 uses the SSE streaming endpoint. This is NOT cosmetic: Metrale Engine's
