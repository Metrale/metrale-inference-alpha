...
pub struct Coherence {
    ...
    /// Metrale Engine answers a completion under whatever model name it is sent, so a
...
///
/// `None` when the endpoint sent the whole reply in one SSE delta — Metrale Engine
