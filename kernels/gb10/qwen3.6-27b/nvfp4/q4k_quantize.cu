...
// superblock. Input bf16 [nrows, n_per_row] (n_per_row % 256 == 0), output GGML metrale_bq4k
...
#define QK_K 256
struct metrale_bq4k { uint16_t d; uint16_t dmin; uint8_t scales[12]; uint8_t qs[128]; }; // 144 B
