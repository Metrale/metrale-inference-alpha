...
//
// The tab draws Metrale Engine against a measured vLLM bar on top and Metrale Engine's own
...
describe('the gate and the published bar declare one instrument', () => {
  ...
  test('the rung floors are cut BELOW every clean rep on this instrument, and never zero', () => {
    ...
    const record = JSON.parse(
      readFileSync(repo('test_data/gate-records/.benchmarks/concurrency-sweep/2026-09-23-6c75c09da4.json'), 'utf8')
    );
