...
/// launch per sequence. Kill switch: `METRALE_NO_ATTN_BATCH_CACHE_WRITE=1`.
...
impl Qwen3AttentionLayer {
    ...
    pub(super) fn ms_phase_rope(&self, c: &MultiSeqCtx<'_>, meta: AttnMetadataDev) -> Result<()> {
        ...
        // Kill switch: METRALE_NO_ROPE_STRIDED=1.
    ...
    pub(super) fn ms_phase_cache_write(
        ...
        //
        // `METRALE_NO_ATTN_BATCH_CACHE_WRITE=1` restores the per-sequence loop.
    ...
    pub(super) fn ms_phase_paged_decode(
        ...
        // Kill switch: METRALE_NO_ATTN_Q_INPLACE=1.
