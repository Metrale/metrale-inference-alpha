#!/usr/bin/env python3
"""
coherence_test.py — Metrale Engine Spark API correctness & coherence test suite.
...
class TestRunner:
        ...
        *model* would enumerate 256+ tokens — which small models legitimately
        ...
        behaviour with model willingness. Two model-agnostic checks instead:
          ...
          A. Explicit budget is enforced — request max_tokens=64 on an
             ...
             — Metrale Engine counts reasoning/thinking tokens into completion_tokens
    ...
    def run_all(self) -> bool:
        ...
        print("Metrale Engine Spark — Coherence Test Suite")
