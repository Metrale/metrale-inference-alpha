    ...
    >
      ...
      <div class="ld-body">
        ...
        {:else if launch.phase === 'connecting'}
          ...
          {#if !launch.placement.canOnboard}
            <!-- The agent named a cause the operator can fix on THIS machine,
                 ...
                 hardware that was fine. These are the same commands metralectl
            ...
            {#if /docker/i.test(launch.placement.detail ?? '')}
              ...
              <p class="ld-place-sub">
                ...
                nothing to restart. Do not use <code>sudo metralectl</code> — it runs
                the model as root and leaves root-owned files in <code>~/.metrale</code>
            ...
            <p class="ld-place-sub">
              <a
                class="link"
                href="https://book.dev.metrale.ai/getting-started/troubleshooting.html"
                target="_blank"
        ...
        {:else if launch.phase === 'guide'}
          <p>
            Metrale Engine runs on your hardware, not ours. This page can start a model for
          ...
          <p class="ld-caution">
            ...
            says <strong>dev.metrale.ai</strong> before running one.
          </p>
        ...
        {:else if launch.phase === 'pairing'}
          ...
          <CommandRow command="metralectl agent token" />
