...
//! 2026-09-26: Tests for `run_task`'s recovery turns, against a loopback server
//! that answers two streamed replies: a first turn cut at `length` or holding
//! unparsed tool-call syntax is sent back in the second request with the
//! instruction to continue or to re-issue the call.
//!
//! Owner: bench, agentic.
