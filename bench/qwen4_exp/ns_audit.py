# 2026-09-26: Collapses the index's tensor names into families (layer, block, expert and
# shard numbers replaced by N) and prints each family's destination label.
#
...
groups = defaultdict(lambda: [0, 0])  # 2026-09-26: [families, tensors]
