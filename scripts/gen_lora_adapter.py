#!/usr/bin/env python
"""Generate a tiny PEFT-format LoRA adapter for Hcompany/Holo-3.1-0.8B (Metrale Engine LoRA MVP test fixture).
...
Output (default /home/ms/metrale/.claude/worktrees/lora-mvp-e0877873/test_data/lora-holo-tiny):
...
Key style (--key-style):
  ...
  text           base_model.model.model.layers.{i}....lora_A.weight
                 -- the text-tower-only form; the Metrale Engine remapper must accept both
...
def main() -> None:
    ...
    ap.add_argument(
        "--out-dir",
        type=Path,
        default=Path("/home/ms/metrale/.claude/worktrees/lora-mvp-e0877873/test_data/lora-holo-tiny"),
    )
