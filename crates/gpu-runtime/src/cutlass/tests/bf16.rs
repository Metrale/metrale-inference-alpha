...
//! 2026-09-25: Dense BF16 CUTLASS tests: correctness, CUTLASS tile variants timed
//! against cuBLASLt, and a cuBLASLt algorithm sweep. All need a GPU and are
//! `#[ignore]`d.
//!
//! Owner: gpu-runtime.
...
fn cutlass_bf16_holo_qkvz_bench_against_cublaslt() {
    ...
    let variants: [(&str, CutlassVariant); 6] = [
        ("128x128", metrale_cutlass_bf16_gemm_act_weight_t),
        ("128x256", metrale_cutlass_bf16_gemm_act_weight_t_128x256),
        ("256x128", metrale_cutlass_bf16_gemm_act_weight_t_256x128),
        ("64x128", metrale_cutlass_bf16_gemm_act_weight_t_64x128),
        ("128x64", metrale_cutlass_bf16_gemm_act_weight_t_128x64),
        ("64x64", metrale_cutlass_bf16_gemm_act_weight_t_64x64),
    ];
