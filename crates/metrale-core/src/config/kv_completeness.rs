...
impl ModelConfig {
    ...
    /// (`METRALE_GLM53_PREFIX_CACHE_UNPROVEN`) that opens the prefix-cache arm and
    ...
    ///
    /// 🧪 `METRALE_GLM53_PREFIX_CACHE_UNPROVEN` (PRESENCE, house convention — `=0`
    ...
    /// The `METRALE_GLM53_PREFIX_CACHE_UNPROVEN` validation switch (PRESENCE).
