...
//! (`METRALE_MTP_MAX_SEQS > 1`); C=1 and the default cap never enter.
...
impl MtpHead {
    ...
    ///   grid, and as the `METRALE_MTP_KV_GEMV` arm.
    ///
    ...
    fn forward_batch_position(
        ...
        for i in 0..n {
            ...
            // METRALE_PROPOSE_META_STRIDE override or a sequence past
            // max_seq_len.
    ...
    fn propose_proj_arm(
        ...
        // only under `METRALE_MTP_KV_GEMV`.
        match row_dispatch::drafter_row_kernel(
            n,
            h as u32,
            (2 * h) as u32,
