...
The model **loads** today (see Metrale Engine #753); it does not serve because these
...
`ARCHITECTURE.md` §2 and Metrale Engine #753 both said the n-gram machinery from
...
§2 above and Metrale Engine #753 both read `ple_layer_ids: [2]` as "model layer 2".
