...
// Metrale Engine Register-Tiled Gated Delta Rule Prefill — 35B model shadow.
//
...
//     recurrent decode behind METRALE_SSM_BATCHED_RECURRENT, and
...
// ── FP16 h-state twins (METRALE_SSM_H_FP16) ─────────────────────────────────
//
...
// remain the only path when METRALE_SSM_H_FP16 is absent.
//
