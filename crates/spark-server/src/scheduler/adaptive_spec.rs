...
//! Adaptive speculation (`METRALE_DFLASH_ADAPTIVE=1`).
//!
...
//!
//! Knobs (env, read once): `METRALE_DFLASH_ADAPTIVE=1` master switch;
//! `METRALE_DFLASH_ADAPTIVE_MIN` mean-accepted suspend threshold (default
//! 2.0); `METRALE_DFLASH_ADAPTIVE_REPROBE` serial tokens between probes
//! (default 256).
...
// The `METRALE_DFLASH_SERIAL_APPEND` and `METRALE_DFLASH_UNIFIED_CTX` statics
...
// The `METRALE_DFLASH_ADAPTIVE*` statics are now `SchedLevers::dflash_adaptive*`.
