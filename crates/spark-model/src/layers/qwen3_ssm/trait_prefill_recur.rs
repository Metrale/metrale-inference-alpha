...
impl Qwen3SsmLayer {
    ...
    pub(super) fn prefill_gdn_recurrence(
        ...
        // gfx1151/SCALE (metrale_scale): every H-in-shared-memory GDN prefill
        ...
        // FlashInfer GDN (opt-in, METRALE_GDN_FLASHINFER=1): tensor-core chunked delta-rule
        ...
        // (METRALE_GDN_CHUNK64 / METRALE_FORCE_PERSISTENT / METRALE_DISABLE_WY4) and their
        ...
        // DEFAULT 2026-06-06 (was gated behind METRALE_GDN_FLA=1 — the env var is gone):
        ...
        // METRALE_NO_GDN_FLA=1: force the WY4 fallback. Diagnostic lever for the
