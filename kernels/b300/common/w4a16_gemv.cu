...
// Metrale Engine W4A16 GEMV — Fused NVFP4 weight dequant + BF16 GEMV for M=1 decode.
//
...
// ============================================================
// W4A16 GEMV — SINGLE-WARP-PER-OUTPUT variant (lossless; default ON, kill METRALE_NO_GEMV_SW=1).
//
...
// (`spark-model/src/layers/w4a16_gemv_tiers.rs`); `METRALE_NO_GEMV_EXACT_M_TIERS=1`
