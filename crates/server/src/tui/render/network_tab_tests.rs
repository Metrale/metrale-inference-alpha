...
//! 2026-09-26: Render tests for the Network section, including that a
//! worker's state and the link latency are reported as not measured.
//!
//! Owner: server tui.
...
fn a_single_node_deployment_gets_a_centrepiece_rather_than_an_empty_screen() {
    let mut a = net(1, 1, 1);
    // 2026-09-26: The card reports system memory (used/total).
...
fn a_world_wider_than_four_draws_the_four_that_fit() {
    ...
    // 2026-09-26: The detail pane still reports the whole world size.
