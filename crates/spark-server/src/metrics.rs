...
//! Prometheus metrics for Metrale Engine Spark.
...
lazy_static! {
    ...
    // ── HTTP byte accounting (Metrale Engine TUI Server Stats) ──
    //
...
/// RAII guard for the `metrale_requests_active` gauge: increments on construction,
...
/// See Metrale/metrale-inference-alpha#368.
///
