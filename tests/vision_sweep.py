...
def launch_container(spec: ModelSpec, image_tag: str) -> str:
    """Start a fresh metrale-gb10 container for the given model.  Returns
    the container name.  Blocks until the server logs 'Listening on'.
    """
    name = f"metrale-vsweep-{spec.label}"
...
def main() -> int:
    ...
    p.add_argument("--image-tag", default="metrale-gb10:qwen36-vision",
