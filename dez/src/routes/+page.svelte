  ...
  <div class="container split">
    ...
    <div class="split-body">
      <p>
        ...
        <a href={LINKS.metraleRepo} rel="noopener noreferrer">Metrale Engine</a> — a pure-Rust
...
<section class="section" id="how" aria-labelledby="how-h">
  <div class="container">
    ...
    <h2 id="how-h">Metrale Engine, retargeted at the browser</h2>
    <p class="lede intro">
    ...
    <p class="footnote">
      Metrale Engine is open source under the AGPL-3.0 and ships hardware- and model-specific kernels behind
      swappable backend traits — the property that makes a WebGPU backend a port rather than a
      rewrite. Read the engine at
      <a href={LINKS.metraleRepo} rel="noopener noreferrer">github.com/Metrale/metrale-inference-alpha</a>.
    </p>
  </div>
</section>
...
<section class="section cta-band" aria-labelledby="cta-h">
  <div class="container">
    ...
    <div class="cta-row">
      <a class="btn primary" href={LINKS.metraleRepo} rel="noopener noreferrer">
        Watch Metrale Engine on GitHub
      </a>
