...
#[link(name="metralegdn")] extern "C" {
    fn metrale_gdn_load();
    fn metrale_gdn_prefill(q:*mut c_void,k:*mut c_void,v:*mut c_void,o:*mut c_void,
...
fn main(){ unsafe{
    ...
    let ret=metrale_gdn_prefill(q,k,v,o,al,be,st,ini,tm,cu, 0.08838834764831843f32, t as c_int,
        16,16,32,32,1, 32, stream);
    cudaDeviceSynchronize();
    println!("Rust->shim->AOT kernel: metrale_gdn_prefill ret={}", ret);
