...
impl TransformerModel {
    ...
    pub(in crate::model) fn ensure_drafter_context(
        ...
        // METRALE_MTP_DRAFTER_PREFILL: on the FIRST propose of a sequence,
        ...
        // context-blindness defect METRALE_MTP_CARRY_DRAFTER closes below.
    ...
    /// METRALE_MTP_CARRY_DRAFTER: give the drafter this turn's prompt context on
    ...
    /// METRALE_MTP_CATCHUP: ring-capture the final hidden of a serially
    ...
    pub(super) fn run_mtp_propose_multi_dispatch(
        ...
        // `METRALE_MTP_EP_PROPOSE=1` the head tells the worker to run the same propose FIRST,
