...
- **Model authors** extending Metrale Engine with a new architecture. Read *Architecture* → *spark-model* → *Engineering Deep Dives* in order, then follow the "Adding a new model" section of the repo README alongside `crates/spark-model/src/weight_loader/minimax.rs` as a template.
