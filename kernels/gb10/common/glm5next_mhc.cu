...
//
// Metrale Engine already has an mHC kernel: `deepseek-v4-flash/nvfp4/hyper_connection.cu`. Its
...
//
// Slice 9's numeric oracle isolated that projection as the ENTIRE residual between Metrale Engine
