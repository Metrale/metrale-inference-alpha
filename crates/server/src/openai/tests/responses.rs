...
//! 2026-09-26: Tests for Responses-API lowering (tool shapes, `tool_choice`, input items)
//! and for Responses stream event names and reasoning wire shapes.
//!
...
fn responses_function_call_output_opaque_array_stringified() {
    // 2026-09-26: An output array with no text or image part is carried as its JSON text.
