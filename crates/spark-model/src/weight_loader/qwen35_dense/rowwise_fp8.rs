...
//!
//! Metrale Engine cannot feed that to its native FP8 kernels: the whole `w8a16` family
...
//! `METRALE_CUBLAS_FP8=1`, this module inert, reaches the same call through the
//! requant path and fails identically. Its sibling is worse —
//! `METRALE_FP8_W8A8=1` passes the heuristic and returns "kililililil…". Both
...
//!
//! For contrast, `METRALE_GDN_BF16_WEIGHTS=1` buys the same precision back
