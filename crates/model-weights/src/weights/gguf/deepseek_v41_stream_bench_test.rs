...
//! single-DGX-Spark generate must stream per token, measured, not estimated.
//!
...
//!
//! Gated `#[ignore]`. Run:
//!   METRALE_SKIP_BUILD=1 cargo test -p metrale-model-weights -- --ignored deepseek_v41_stream --nocapture
