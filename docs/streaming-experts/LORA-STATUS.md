# Metrale Engine LoRA — status report (2026-07-06)
...
- **Serving a fine-tuned adapter, multi-adapter, runtime swap, and a fused
  ...
  were trained on GB10 (codewords STARFALL-4728 and MOONVEIL-3390) and pushed to
  HF (`MonumentalSystems/Holo-3.1-0.8B-lora-demo`, `-demo-2`).
- **Per-request routing works in *decode* under `--scheduler slai`** — two
