...
//! Log-once route lines for the `METRALE_ATTN_M16_TC` tensor-core tier (#927).
//!
//! H100 round 9 (2026-09-11) ran cell W (`METRALE_ATTN_M16_TC=1`) and found the
...
//! so it plainly armed — but unlike `METRALE_LM_HEAD_M16_TC` (which logs a
