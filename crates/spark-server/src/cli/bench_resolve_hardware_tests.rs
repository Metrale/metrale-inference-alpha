...
//! (`metrale_plugin::hardware::ids`), not the assembled baseline.

use super::tests::baseline;
use super::*;

/// Oracle: `metrale_plugin::hardware::ids::KNOWN_HARDWARE_IDS` — the registry of
/// box classes Metrale Engine recognises — crossed with the Hopper campaign's premise
