...
// Metrale Engine drives: it accepts sampled tokens, fills the next-token accept
...
//              close to a stop-legal state (Metrale Engine budget-aware close).
...
//    than a `DLTensor` — the W7 API shim adapts it to Metrale Engine's tensor.
