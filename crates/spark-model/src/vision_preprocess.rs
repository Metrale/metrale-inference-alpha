...
fn decode_image(data_uri: &str) -> Result<DynamicImage> {
    ...
    //
    // Measured on 2026-08-14: Metrale Engine ignored the tag entirely. Every viewer the
...
/// multimodal processor controls. `None` preserves Metrale Engine' historical 1280px
/// long-side cap.
