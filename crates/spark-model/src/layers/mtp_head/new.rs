...
impl MtpHead {
    pub fn new(
        ...
        // METRALE_PROPOSE_META_STRIDE=<bytes>.
        ...
        // The catch-up feed (METRALE_MTP_CATCHUP) runs through the same batched
        ...
        Ok(Self {
            ...
            // convention (`METRALE_NO_MTP_LMHEAD_TGEMM=0` is NOT off).
