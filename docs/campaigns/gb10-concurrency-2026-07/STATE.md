...
`METRALE_TARGET_MODEL=qwen3.6-27b cargo build -p spark-server --release --features cuda`;
...
`METRALE_TARGET_MODEL=qwen3.6-27b cargo build -p spark-server --release --features cuda`; ONE FRESH
