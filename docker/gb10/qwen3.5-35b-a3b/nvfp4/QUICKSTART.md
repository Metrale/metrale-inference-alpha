# Metrale Engine Spark — Qwen3.5-35B-A3B Quick Start
...
```bash
docker pull metrale/metrale-qwen3.5-35b-a3b-alpha
```
...
curl http://localhost:8888/v1/chat/completions \
  ...
  -d '{"model":"m","messages":[{"role":"user","content":"Why is the Metrale Engine now seriously on the map?"}],"max_tokens":256}'
```
