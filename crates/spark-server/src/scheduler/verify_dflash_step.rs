...
pub fn step_verify_dflash(
    ...
    // STEP-TIMING (METRALE_DFLASH_STEP_TIMING=1): split the ~0.88s/step into
    ...
    // Adaptive speculation (METRALE_DFLASH_ADAPTIVE=1): feed the rolling
    ...
    // EAGLE-fix (METRALE_DFLASH_EAGLE_FIX=1): append one ctx slot per committed
    ...
    // Unified ctx commit (METRALE_DFLASH_UNIFIED_CTX=1): ONE unconditional
