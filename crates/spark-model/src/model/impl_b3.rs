...
impl TransformerModel {
    pub(super) fn run_mtp_propose_inner(
        ...
        // METRALE_DFLASH_DEBUG_DUMP_FULL=1: emit the full token sequence
        ...
        // running this same propose (`METRALE_MTP_EP_PROPOSE=1`) — a comm without a partner is
        // the `t58` deadlock.
        ...
        // METRALE_MTP_CATCHUP: before proposing, feed pairs the drafter missed
        ...
        if crate::speculative::mtp_catchup_enabled() && !self.mtp_catchup_ring.is_null() {
            ...
            // METRALE_MTP_REFEED_DEBUG: the ring round-trip check. The pair key
        ...
        // Confidence clamp (METRALE_MTP_DRAFT_CONF, staged off by default):
