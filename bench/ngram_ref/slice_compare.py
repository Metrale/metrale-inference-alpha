...
# 2026-09-26: Asks a running serve of the sliced LongCat checkpoint for one greedy token and compares its id with the expected argmax.
#
# Owner: bench, n-gram reference.
# Invariants: none beyond the types.
"""Compare a live Metrale Engine serve of the SLICED LongCat checkpoint against the
...
if isinstance(top, dict) and top:
    # 2026-09-26: top_logprobs maps token text to logprob; ids come only from
    # logprobs.token_ids (or tokens_ids) when the server sends them.
