...
Metrale main (bf16-KV) e2e: wall 4551.9s / TPOT 38.18 / TPS 17.56 / BFCL ~87 / IoU 0.6285.
Confirmed vLLM: wall 5361s / tps 14.6 / BFCL 86.43 / IoU 0.6269.
→ **Metrale wins wall −15% / TPS +20% / BFCL / IoU-tie.** The RAW per-token TPOT (~38ms) is roofline-bound
