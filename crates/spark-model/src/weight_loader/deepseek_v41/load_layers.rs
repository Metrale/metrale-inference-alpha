...
pub(super) fn load_layers(
    ...
    // `METRALE_DS41_ARENA_DEVICE=0` restores the page-locked arena the GPU
    ...
    // `METRALE_DS41_READER_POOL=1`: the persistent reader pool (misses and
    // predicted experts in flight together; what `METRALE_DS41_PREFETCH_K`
