...
//
// METRALE native Ternary-Bonsai Q2_0 prefill GEMM via the vendored llama.cpp MMQ
...
// `metrale_q8_1_quantize_ds4_bf16` (DS4 layout) from q4k_mmq.cu; none is defined
...
// metrale_q4k_tile — calls the shared __device__ mul_mat_q_process_tile with the
