...
// Metrale Engine BF16 Grouped MoE GEMM — for FP8-source models dequanted to BF16 at load.
//
...
// confirmed Metrale Engine's existing FP8 path has only ~0.001 cosine/layer headroom
