...
//! 2026-09-25: Parity of the Turbo4 kernels: the K bytes of
//! `kv_cache_append_turbo4` against a CPU quantizer, and `attention_decode_turbo4`
//! against a CPU reference over the CPU-dequantised cache.
//!
...
/// 2026-09-25: One group of 16 through the steps of `kv_cache_append_turbo4.metal`:
...
/// 2026-09-25: `kv_cache_append_turbo4` writes the K nibble packs and E4M3 scales
...
/// 2026-09-25: `attention_decode_turbo4` against a CPU reference over the
