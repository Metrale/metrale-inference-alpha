#!/usr/bin/env python3
# 2026-09-26: Sends five short greedy chat prompts and exits 1 if any reply is empty,
# ends in a repeated word pattern, or holds five back-to-back copies of a 5+ character run.
#
# Owner: bench, correctness probes.
# Invariants: none beyond the types.
"""Quick correctness probe for Qwen3.5-35B-A3B-FP8 with METRALE_FP8_MOE_COALESCED=1.
...
def looks_repetitive(text: str, window: int = 20, repeats: int = 3) -> bool:
    ...
    for i in range(1, repeats):
        ...
        # 2026-09-26: Up to two differing words still count as the same pattern.
