...
impl TransformerModel {
    pub(super) fn prefill_b_forward_layers(
        ...
        // Consume the one-shot METRALE_PROFILE_FIRST flag (additive).
        ...
        // HOST-TIME instrumentation (METRALE_PREFILL_HOST_TIMING=1). Distinct
        ...
        for (i, layer) in self.layers.iter().enumerate() {
            ...
            // Hyper-stream RMS trail (`METRALE_DUMP_HYPER_RMS=1`): after each
            ...
            // unset). `METRALE_NEMO_DUMP=<dir>` writes the LAST token's full
            // post-layer residual-stream hidden vector for every layer as
            // headerless little-endian f32: `<dir>/metrale_L{i}.bin`. Overwrites
        ...
        // METRALE_MTP_DRAFTER_PREFILL: capture this chunk's final-layer hidden
