...
//! 2026-09-25: Tests for `Teardown`: release order and failure aggregation.
//!
//! Owner: metrale-core.
//! Invariants: the tests touch no global state.

use std::sync::Mutex;

use super::*;

/// 2026-09-25: Stands in for the allocator a real resource frees through.
struct Allocator;
