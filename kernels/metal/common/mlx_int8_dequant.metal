...
// 2026-09-26: MLX 8-bit weights to BF16. Column c of a row is byte c % 4 (from the low
// byte) of `uint32` word c / 4; each group of `group_size` columns of a row has one bf16
// scale and one bf16 bias:
//
