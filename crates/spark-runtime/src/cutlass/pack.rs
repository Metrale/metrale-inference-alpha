...
/// Repack a Metrale Engine E4M3 weight scale into the CUTLASS SM120 blockscaled SFB
...
///
/// `src_n_major` selects the SOURCE layout: `false` = Metrale-transposed
...
/// first materialising a Metrale-transposed copy. Output layout is identical
/// either way.
...
/// packed `[N,K/2]` (N-major, K-contiguous — NOT the Metrale Engine transposed `[K/2,N]`)
...
/// Transpose a Metrale-packed NVFP4 weight from the checkpoint/hand-kernel
