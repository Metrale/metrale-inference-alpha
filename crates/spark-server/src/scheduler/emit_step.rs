...
pub fn emit_token(
        ...
        && let Some(ref mut gs) = a.grammar_state
    {
        ...
        if !advanced {
            ...
            // reference) does by parsing tools post-hoc. Metrale Engine's server-side
    ...
    // turn. Inert unless METRALE_TOOL_EOS_ESCAPE=1.
...
/// (`METRALE_GRAMMAR_BUDGET_CLOSE=0`), inside `<think>`, or when no bounded close
