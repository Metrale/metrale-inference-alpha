#!/usr/bin/env python3
"""
Metrale Engine Agentic Multi-Turn Session Tester
...
WORK_DIR = Path("/tmp/metrale-agentic-test")
MAX_TURNS = 15
...
def main():
    ...
    print(f"{'='*60}")
    print(f"Metrale Engine Agentic Multi-Turn Session Tester")
    ...
    # Save results
    with open("/workspace/metrale/agentic_test_results.json", "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nResults saved to /workspace/metrale/agentic_test_results.json")
