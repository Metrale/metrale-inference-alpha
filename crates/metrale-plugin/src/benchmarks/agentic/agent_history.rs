...
///
/// Metrale Engine mints ids from a per-process counter (`call_0000000000000004`), so the
...
/// `METRALE_AGENTIC_PRESERVE_THINKING=1`: echo each turn's `reasoning_content`
