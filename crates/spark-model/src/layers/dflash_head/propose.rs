...
impl BlockDiffusionDraftHead {
    pub(super) fn propose_drafts(
        ...
        // Gated METRALE_DFLASH_CTX_PARITY_DUMP=1. One-shot. Writes the ENTIRE
        ...
        // accepted-prefix tokens; this proves whether Metrale Engine's accumulator has
        // the same BREADTH and the same per-slot 5-layer values).
        //
        // Layout of /tmp/metrale_ctx_parity.bin: contiguous BF16,
        ...
        // Metrale Engine's existing op wrappers per bullet):
        //
        ...
        //      decoded positions; Metrale Engine currently captures only the latest
        ...
        //
        // METRALE_DFLASH_DEBUG_NO_DECODE_APPEND=1 disables the post-decode
        ...
        // When METRALE_DFLASH_OPTION_B=1 and the proposer hasn't yet
        ...
        let option_b_arg: Option<(DevicePtr, u32)> = if option_b_enabled {
            ...
            //
            // Escape hatch: METRALE_DFLASH_DEBUG_FULL_PRECOMPUTE=1 forces a
            ...
            // With METRALE_DFLASH_CTXLEN_PROBE=1, validate the ctx position
            ...
            // Gated METRALE_DFLASH_CTXLEN_PROBE=1, rate-limited to ~1/16 steps
            // to avoid log flood.
            ...
            // Ablation: METRALE_DFLASH_OPTION_B_NO_CTX=1 forces ctx_count=0
        ...
        // METRALE_DFLASH_DRAFT_CAP=N (N=1 to force K=2 path for ablation).
        ...
        // METRALE_DFLASH_VERIFY_TRACE=1: log all γ drafts BEFORE the cap so we
        ...
        // vLLM ignores row 0 via `token_indices_to_sample`. Metrale Engine was
