...
Metrale Engine sees two layouts on disk, both handled by the format modules under `crates/model-layers/src/quant_format/`:
...
Two paths exist in the code today, selected per layer in `metrale-model-layers::quant_format`:
