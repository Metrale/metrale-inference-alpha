/**
 * Metrale Engine chevron field — raw WebGL2, no dependencies.
 *
...
// web-shared/metrale-tokens.css, and a copy of them in this file is a second
...
const DEFAULTS = {
  /* Contrast-derived, not a taste value.
     ...
     With the clamp and the Metrale Engine palette (--t3 #82868F on #0F1216) AA was
     reached exactly at density 1.0119, and 0.85 measured 4.61:1. On the
     Metrale kit's --t3 #8A8F99 over #0E1318, 0.85 measures 5.14:1 (run
     `bun .contrast-check.mjs`). Raising this past the bound fails the check. */
  density: 0.85,
