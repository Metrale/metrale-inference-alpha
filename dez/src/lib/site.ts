 ...
 * the Metrale Engine repository it does not belong in this file.
 */
...
export const DESCRIPTION =
  'An IDE built on the Metrale Engine, WebGPU, Rust and 100% WebAssembly. ' +
...
export const FEATURES: readonly Feature[] = [
  ...
  },
  {
    ...
    body:
      'Dez follows Metrale Engine: source-available to read, fork and audit under the AGPL-3.0. ' +
...
export const PIPELINE: readonly PipelineStage[] = [
  {
    step: '01',
    title: 'Metrale Engine, in Rust',
    body:
      'Metrale Engine is a pure-Rust LLM inference engine: scheduler, model graph and hardware-specific ' +
  ...
  },
  {
    ...
    body:
      ...
      'and tokenisation logic is the code Metrale Engine already runs on servers — retargeted, not rewritten.'
  },
  {
    step: '03',
    title: 'Dispatched over WebGPU',
    body:
      'Metrale Engine is built around swappable hardware backends. In the browser that backend is WebGPU: ' +
