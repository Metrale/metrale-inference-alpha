...
//! 2026-09-26: Tests for the campaign lockfile: claim, liveness, reclaim, heartbeat.
//!
...
/// 2026-09-26: Negative control: a live lock is refused, and the refusal names the owner.
#[test]
...
/// 2026-09-26: A recent heartbeat keeps a non-terminal lock live even when its pid is gone.
#[test]
...
/// 2026-09-26: A finished campaign's lock is reclaimable the moment its driver is gone,
...
fn a_finished_campaign_with_a_dead_driver_is_reclaimed_at_once() {
    for status in TERMINAL_STATUSES {
        ...
        // 2026-09-26: Negative control: the recorded driver pid is alive, so the
        // claim is refused whatever the status says.
...
/// 2026-09-26: Negative control: a file that is not a lockfile is never silently replaced.
#[test]
