...
// forked-from: kernels/gb10/common/attn_prefill_fp8kv.cu (2026-09-24; 437 of 493 lines differ, see kernels/FORKS.md)

// 2026-09-25: Flash-attention prefill for HDIM = 256 on AMD WMMA (gfx1151),
// full or causal, with BF16 Q and FP8 E4M3 K/V (no scales) decoded to BF16
// in shared memory. One block per (q_head, 32-row q block, batch); warps 4
// and above return at once. Layouts and exp as in attn_prefill_v47.cu. No
// crate looks up attn_prefill_fp8kv_64.
//
// Owner: strix-hip kernels.
// Invariants: assumes head_dim == HDIM (256).
...
// 2026-09-25: E4M3 -> FP32 decode, the same function as scl_fp8 in kernels/gb10/common/attn_prefill_fp8kv.cu; 0x7F/0xFF decode to 0.
