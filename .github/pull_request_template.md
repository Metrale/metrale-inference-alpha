<!--
Thanks for contributing to Metrale Engine! A few reminders:
...
- If you add a new source file, it needs `// SPDX-License-Identifier: MIT OR Apache-2.0`
  on line 1.
-->
...
- [ ] `cargo fmt --all -- --check`
- [ ] `METRALE_SKIP_BUILD=1 cargo clippy --workspace --tests --all-features -- -Dwarnings`
