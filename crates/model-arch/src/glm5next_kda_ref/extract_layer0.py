# 2026-09-25: Extracts layer 0's self_attn tensors and input_layernorm from shard 1 of 120 into a
# standalone safetensors file on stdout; diagnostics go to stderr.
#
# Owner: model-arch (GLM-5.3-Flash KDA reference).
# Invariants:
# - Reads the checkpoint only; writes only to stdout and stderr.
