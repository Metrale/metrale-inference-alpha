...
impl Qwen3AttentionLayer {
    ...
    pub(in super::super) fn ms_phase_o_proj(
        ...
        if let Some(q2) = self.o_weight.as_ref().and_then(|w| w.as_packed_q2()) {
            ...
            // METRALE_FP8_DEQUANT_ATTN_TO_BF16: O-proj dequanted to BF16 at load.
            ...
            // #927 tensor-core tier, same 16-row group, `METRALE_ATTN_M16_TC`
            // (or the `METRALE_M16_TC` umbrella) only — NOT the FFN's lever; the
