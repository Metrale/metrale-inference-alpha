...
/// dlopens the library named by `METRALE_GDN_LIB`, and a committed recipe fixture
/// points that at `3rdparty_patches/gdn_aot/libmetralegdn.so` on a config
...
/// excludes the whole `crates/metrale-plugin/src/gate` prefix from every gate,
...
/// only an unrelated `metrale-kernels` file as invalidating. It read red purely
/// by accident.
///
...
pub const BOUNDARY_FILES: [&str; 14] = [
    "crates/metrale-plugin/src/gate/coverage.rs",
    ...
    "crates/metrale-plugin/src/gate/required.rs",
    ...
    "crates/metrale-plugin/src/gate/check.rs",
    ...
    "crates/metrale-plugin/src/gate/check_paths.rs",
    ...
    "crates/metrale-plugin/src/gate/check_group.rs",
    ...
    "crates/metrale-plugin/src/gate/agreement.rs",
    ...
    "crates/metrale-plugin/src/gate/hermetic.rs",
    ...
    "crates/metrale-plugin/src/gate/amnesty.rs",
    ...
    "crates/metrale-plugin/src/gate/group.rs",
];
...
const GATE_MACHINERY_FILES: &[&str] = &[
    ...
    "crates/metrale-plugin/src/gate/record.rs",
    "crates/metrale-plugin/src/gate/record_path.rs",
    ...
    "crates/metrale-plugin/src/gate/record_env.rs",
    "crates/metrale-plugin/src/gate/record_summary.rs",
    // Rendering and reporting only.
    "crates/metrale-plugin/src/gate/card.rs",
    "crates/metrale-plugin/src/gate/check_fmt.rs",
    "crates/metrale-plugin/src/gate/telemetry.rs",
    "crates/metrale-plugin/src/gate/telemetry_order.rs",
    // Ownership resolution for the telemetry table; no gate consults it.
    "crates/metrale-plugin/src/gate/codeowners.rs",
    ...
    "crates/metrale-plugin/src/gate/pr_taxonomy.rs",
    ...
    "crates/metrale-plugin/src/gate/signing.rs",
    // Test-only baseline fixtures.
    "crates/metrale-plugin/src/gate/fixture_baseline.rs",
    // Module wiring.
    "crates/metrale-plugin/src/gate/mod.rs",
...
pub const TEST_ONLY_RUST_MODULES: &[TestOnlyRustModule] = &[
    ...
    TestOnlyRustModule {
        path: "crates/metrale-core/src/config/tests.rs",
        parent: "crates/metrale-core/src/config.rs",
        name: "tests",
        declared_path: None,
    },
    TestOnlyRustModule {
        path: "crates/metrale-core/src/config/gguf/tests.rs",
        parent: "crates/metrale-core/src/config/gguf.rs",
        name: "tests",
        declared_path: None,
    },
    TestOnlyRustModule {
        path: "crates/metrale-core/src/config/parsers/lora_tests.rs",
        parent: "crates/metrale-core/src/config/parsers/lora.rs",
        name: "tests",
        declared_path: Some("lora_tests.rs"),
    },
    TestOnlyRustModule {
        path: "crates/metrale-plugin/src/benchmarks/concurrency_tests.rs",
        parent: "crates/metrale-plugin/src/benchmarks/concurrency.rs",
    ...
    TestOnlyRustModule {
        path: "crates/metrale-plugin/src/benchmarks/concurrency_verdict_tests.rs",
        parent: "crates/metrale-plugin/src/benchmarks/concurrency.rs",
    ...
    TestOnlyRustModule {
        path: "crates/metrale-plugin/src/benchmarks/concurrency_moe_tests.rs",
        parent: "crates/metrale-plugin/src/benchmarks/concurrency.rs",
...
const GATE_MACHINERY: Exclusion = Exclusion {
    prefix: "crates/metrale-plugin/src/gate",
...
const BFCL_EXCLUDES: &[Exclusion] = &[
    GATE_MACHINERY,
    other_driver(
        "crates/metrale-plugin/src/benchmarks/ttft",
