...
>
  <div class="grid2">
    <Kv
      rows={[
        ['code', `Metrale Engine ${claim.build}`, 'plus the certified SHA and the merge commit, all three named'],
...
>
  <div class="grid2">
    ...
    <ul class="links">
      ...
      <li><span class="mono">source</span><a class="link" href={links.repo} target="_blank" rel="noopener">github.com/Metrale/metrale-inference-alpha</a></li>
