...
//
// Launchers for the vendored llama NVFP4 W4A4 MMQ FFN prefill GEMM (METRALE_FFN_NVFP4_MMQ).
...
// folded by the caller in metrale_nvfp4_silu_mul_scaled (empirical ratio 0.99 ≈ 1.0, see
...
pub fn nvfp4_mmq_repack(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_nvfp4_repack
    packed: DevicePtr,
    scales: DevicePtr,
...
pub fn nvfp4_mmq_quantize_act(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_nvfp4_quantize_bf16
...
pub fn nvfp4_mmq_gemm(
    gpu: &dyn GpuBackend,
    kernel_nc: KernelHandle, // metrale_nvfp4_mmq128_nc
    kernel_wc: KernelHandle, // metrale_nvfp4_mmq128_wc
...
pub fn nvfp4_silu_mul_quant(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_nvfp4_silu_mul_quant
    gate: DevicePtr,
    up: DevicePtr,
    out_y: DevicePtr,
    gate_scale: f32,
...
pub fn nvfp4_scale_bf16(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_nvfp4_scale_bf16
    data: DevicePtr,
    scale: f32,
    total: u32,
    stream: u64,
...
pub fn nvfp4_silu_mul_scaled(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_nvfp4_silu_mul_scaled
    gate: DevicePtr,
    up: DevicePtr,
    out: DevicePtr,
    gate_scale: f32,
