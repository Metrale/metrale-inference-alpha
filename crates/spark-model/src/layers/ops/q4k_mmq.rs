...
//
// Launchers for the vendored llama Q4_K MMQ FFN prefill GEMM (METRALE_FFN_MMQ).
...
pub fn quantize_act_q8_1(
    gpu: &dyn GpuBackend,
    kernel: KernelHandle, // metrale_q8_1_quantize_ds4_bf16
    input_bf16: DevicePtr,
    out_q8: DevicePtr,
    m: u32,
    k: u32,
...
pub fn q4k_mmq_gemm(
    gpu: &dyn GpuBackend,
    kernel_nc: KernelHandle, // metrale_q4k_mmq128_nc
    kernel_wc: KernelHandle, // metrale_q4k_mmq128_wc
