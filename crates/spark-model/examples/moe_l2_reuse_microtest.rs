...
//!
//! THE QUESTION. Production telemetry (METRALE_MOE_UNION_STATS=1) shows expert
...
//!
//! Run:
//!   docker run --rm --gpus all -v REPO:/workspace/metrale \
//!     -v /home/ms/metrale-target:/workspace/metrale/target -w /workspace/metrale \
//!     -e 'METRALE_TARGET_MODEL=*' -e 'METRALE_TARGET_QUANT=*' -e METRALE_TARGET_HW=gb10 \
//!     metrale-gb10:gdnf32-build cargo run -p spark-model --release \
