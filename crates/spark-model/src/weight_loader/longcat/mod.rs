...
//!
//! Architecture (HF `modeling_longcat_flash.py`), and how it maps onto Metrale Engine:
//!
...
//!   of sublayer 2. Metrale Engine serves each SUBLAYER as one `Qwen3AttentionLayer`
...
//! - MLA is the DeepSeek-lineage q-LoRA form Metrale Engine already serves; the two
...
impl ModelWeightLoader for LongcatWeightLoader {
    ...
    fn load_layers(
        ...
        // Same measurement lever the Mistral MLA loader has: METRALE_NVFP4_MLA=0
    ...
    fn load_mtp_weights(
        ...
        // the Qwen-style one Metrale Engine builds. Ignored (matches HF's own
