...
| bg rect | `<rect width="1200" height="928" fill="#0E1318"/>` | `<rect width="1200" height="1040" fill="#0E1318"/>` |
...
(they only define the `tip*` markers). Logo, title and
...
- White plaque, near-black modules (`#0E1318`), no rotation, no gradient, no
