...
### New files (4)
- `crates/metrale-core/src/config/parsers/step3p7.rs` — config parser (287 lines)
...
### Modified files (4)
- `crates/metrale-core/src/config.rs` — re-export `parse_step3p7`
- `crates/metrale-core/src/config/dispatch.rs` — `"step3p7"` dispatch arm
- `crates/metrale-core/src/config/parsers/mod.rs` — module + re-export
