...
# 2026-09-26: Chained multi-turn chat at temperature 0; save the transcript to diff a cached run against an uncached one.
#
...
Drives N chained "turns" against a single running Metrale Engine server at temp 0:
...
def main():
    ...
    # 2026-09-26: The system prompt alone (FILLER x 320, 42,560 characters) is longer
    # than the default SSM checkpoint interval (256 blocks = 4096 tokens at
    # block_size 16), so the first turn already crosses a checkpoint boundary.
    system = (
