...
//! 2026-09-25: Checks of the harness itself: the golden parses, the RNG-free
//! filler regenerates the generator's inputs and f32-kind weights, every
//! capture the graph is checked against is present and internally
//! consistent, and the comparator catches a planted defect.
//!
...
fn every_capture_the_graph_will_be_checked_against_is_present() {
    ...
    // 2026-09-25: The ratio-2 kv source (layer 2) publishes 12 / 2 = 6 latent
    // rows, the ratio-1 kv source (layer 4) 12.
