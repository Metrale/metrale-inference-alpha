...
#
# Output:
#   /workspace/metrale-dumps/numdrift/phase2c-<config_name>/metrale_L*.bin
#   /workspace/metrale-dumps/numdrift/phase2c-<config_name>/metrale_final_norm.bin
#   /workspace/metrale-dumps/numdrift/phase2c-<config_name>/metrale_logits.bin
#   /workspace/metrale-dumps/numdrift/phase2c-<config_name>/cosine.txt   <- summary table
#
...
# Run cosine compare against HF reference at /workspace/metrale-dumps/numdrift/hf_*.bin
