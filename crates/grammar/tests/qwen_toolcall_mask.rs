...
use metrale_grammar::compiler::GrammarCompiler;
use metrale_grammar::detect_metadata_from_hf;
...
/// Build the ordered vocab exactly as metrale-server's
...
/// Build a `TokenizerInfo` the way metrale-server's
