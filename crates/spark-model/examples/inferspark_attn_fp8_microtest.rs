...
//! `METRALE_ATTN_FP8_SMEM` optimization (K/V kept in shared memory as raw E4M3
...
fn main() -> Result<()> {
    ...
    // METRALE_QLEN/METRALE_KVLEN/METRALE_QOFF default to self-attention (qlen=kvlen=seq,
    ...
    // METRALE_BENCH_ITERS so the correctness gate stays the default behaviour.
