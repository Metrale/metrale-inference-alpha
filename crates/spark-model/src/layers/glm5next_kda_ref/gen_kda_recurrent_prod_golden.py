...
# HF's kernel L2-normalises q/k internally. The Metrale Engine kernel consumes ALREADY-normalised
# q/k (its conv fuses the L2), so the golden records the normalised tensors that Metrale Engine
