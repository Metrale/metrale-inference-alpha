...
impl BlockDiffusionDraftHead {
    ...
    pub(super) fn precompute_ctx_kv(
        ...
        // One-shot diagnostic dump (METRALE_DFLASH_PRECOMPUTE_DUMP=1).
        ...
        // Metrale Engine: copy row-by-row to build the same [L, n, kv_dim] layout.
        ...
        // Metrale Engine: rope_yarn with seq_len=L*n, num_q_heads=0 (K-only).
