#!/usr/bin/env bash
# Serve Qwen3.8-Flash-Next (model_type qwen4_exp) — port tracked in Metrale Engine #753.
#
...
# Routed-MoE GEMM variants (METRALE_MOE_GROUPED_K32 / _M256) default OFF —
...
export METRALE_MOE_GROUPED_K32="${METRALE_MOE_GROUPED_K32:-0}"
