...
Usage:
  python3 metrale_bench_comprehensive.py \\
    --image metrale-gb10-tqplus \\
...
PORT = 8889
CONTAINER = "metrale-bench"
HOST = "localhost"

# Single Manhattan-Project PPL prompt (matches /tmp/metrale_matrix_no_hp.py and
