# Release record — `metrale/metrale-inference-gb10:dev` @ `288c17c`

- **Git**: `main` @ `288c17c1` (`fix(openai): emit only reasoning_content, drop redundant reasoning mirror`, #271)
- **Image**: `metrale/metrale-inference-gb10:dev` (also tagged `:288c17c`), image config `sha256:e238efaf…`
- **Date**: 2026-07-06
...
```
met serve nvidia/Qwen3.6-27B-NVFP4 --model-name Qwen3.6-27B-Q4_K_M \
