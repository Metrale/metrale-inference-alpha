...
//! 2026-09-25: Shared beam-hypothesis resolution for the two prefill entry points
...
use anyhow::Result;
use metrale_model_engine::traits::{BeamReq, Model, SequenceState};

/// 2026-09-25: Resolve a beam request's winning hypothesis: the scheduler's pre-computed
