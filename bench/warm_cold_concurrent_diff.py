#!/usr/bin/env python3
# 2026-09-26: Sends each case's turn-2 conversation once serially as the reference,
# then ROUNDS times with CONC requests in flight, and counts replays whose greedy
# answer differs from the reference. Exits 1 on any difference.
#
