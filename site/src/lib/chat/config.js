...
export const CORPUS_GZ_URL =
  'https://metrale.github.io/metrale-inference-alpha/coderag/metrale-coderag.jsonl.gz';
export const CORPUS_META_URL =
  'https://metrale.github.io/metrale-inference-alpha/coderag/metrale-coderag.jsonl.meta.json';
...
export const APP_TITLE = 'Metrale Engine Ask the Codebase';
export const SITE_ORIGIN = 'https://dev.metrale.ai';
