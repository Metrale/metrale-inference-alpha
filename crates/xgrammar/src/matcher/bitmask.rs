...
//     Metrale Engine's W7 shim can hand the matcher whatever buffer it owns.
//
...
impl TokenBitmask {
    ...
    /// The packed `i32` words — the layout Metrale Engine hands to the kernel.
    #[must_use]
...
///
/// `FillNextTokenBitmask` in the C++ takes a `DLTensor*`; Metrale Engine owns
