...
// 2026-09-25: Kernels `attn_prefill_paged_turbo3k_turbo8v` and `_64`: paged prefill flash attention with a turbo3 K
...
// (`tq3_k_bsb`/`tq3_k_dsb`, `tq8_v_bsb`/`tq8_v_dsb`). The K loader is attn_prefill_paged_turbo3.cu's with the
// turbo3 codebook in `k_lut`, and the V loader is attn_prefill_paged_turbo8.cu's (FP8 E4M3 values, one BF16 scale per
...
#define KERNEL_NAME attn_prefill_paged_turbo3k_turbo8v
