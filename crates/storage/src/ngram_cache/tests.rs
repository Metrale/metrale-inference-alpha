...
//! 2026-09-25: Tests for `NgramRowCache`'s aligned scratch, its row-size limit and the
//! block arithmetic of a straddling row.
//!
...
fn row_wider_than_a_block_is_refused() {
    // 2026-09-25: A row larger than one block could span three with an unaligned base.
...
/// 2026-09-25: With unaligned base offsets, rows land at every phase of a 4 KiB block,
/// and the covering span stays within two blocks. The test recomputes the block
/// count itself rather than calling `nblocks_for`.
#[test]
