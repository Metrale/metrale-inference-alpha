...
//! Metrale Engine Spark — pure Rust LLM inference server.
//!
//! Startup sequence:
//! 1. Parse CLI args
//! 2. Load model config
//! 3. Initialize GPU backend (MetraleCudaBackend)
...
fn main() -> Result<()> {
    // Equivalent to `#[tokio::main]`: multi-threaded, `enable_all`, default
    // worker count.
