...
# 2026-09-26: Long-code degeneration harness: N seeded streamed completions, each scored by analyze.mjs.
#
# Owner: bench, long-code harness.
# Invariants: none beyond the types.
"""N>=10 statistical long-code degeneration harness for Metrale Engine.
...
PASS_GATE_FRAC = 0.8
OVERRIDES: dict = {}  # 2026-09-26: set in main(); empty sends no sampling overrides
...
def main() -> int:
    ...
    # 2026-09-26: Sampling overrides, sent only when passed; otherwise the server's
    # own sampling preset applies.
    ...
    # 2026-09-26: Only the flags actually given go into OVERRIDES.
    global OVERRIDES
    OVERRIDES = {}
    ...
    seeds = list(range(1, args.n + 1))  # 2026-09-26: seeds 1..n, so runs pair by seed
    ...
    for seed in seeds:
        ...
        if args.reanalyze:
            ...
            except Exception as e:  # 2026-09-26: any error fails that seed
                per_seed.append(
