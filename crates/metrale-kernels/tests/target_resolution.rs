...
//! GPU-free `METRALE_SKIP_BUILD=1` runner where `all_ptx_sets()` is an empty
//! stub.
//!
...
use metrale_kernels::{ModelTypeMatch, resolve::resolve_pinned};
...
/// (`METRALE_SKIP_BUILD=1`): every set of differently-named targets sharing a
