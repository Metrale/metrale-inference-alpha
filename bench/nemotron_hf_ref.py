...
# 2026-09-26: HF GPU reference for Nemotron-3-Nano: dequantize NVFP4 to BF16, run the chat prompt, dump per-layer states and logits.
#
# Owner: bench.
...
logits in headerless little-endian f32 .bin -- the format the Metrale Engine
METRALE_NEMO_DUMP hook writes -- so the comparator can diff 1:1.
