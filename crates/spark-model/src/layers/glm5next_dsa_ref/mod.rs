...
//! bound. Its only job is to pin the equations in Metrale-shaped code against goldens produced by
...
/// tie does not straddle the cutoff. This function pins a total order so Metrale Engine is reproducible
/// regardless.
pub fn topk_pools(
    scores: &[f32],
    valid_candidates: &[u8],
