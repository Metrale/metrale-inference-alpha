...
# 2026-09-26: Writes compacted n-gram test data (touched table rows, projections, golden) for the GPU unit test.
#
# Owner: bench, n-gram reference.
# Invariants: none beyond the types.
"""Emit COMPACTED n-gram test data for the Metrale Engine GPU unit test.
...
# 2026-09-26: 16 tokens from seed 7, the golden npz's draw (asserted below).
...
# 2026-09-26: Word-embedding rows of the unique tokens, sorted.
...
# 2026-09-26: The golden fused embeddings, copied from the npz as raw f32.
