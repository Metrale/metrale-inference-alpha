...
pub(super) fn maybe_run_minimax_m2_moe_transpose(
    ...
    // requires METRALE_UNIFIED_MOE_LAYOUT=1, same as minimax_m2/step3p7. Additive —
    ...
    let safety: usize = std::env::var("METRALE_MOE_TRANSPOSE_SAFETY_MB")
        ...
        .map(|mb| mb * 1024 * 1024)
        .unwrap_or(2 * 1024 * 1024 * 1024); // 2 GB default, override via METRALE_MOE_TRANSPOSE_SAFETY_MB
