...
// ── The tensor-core arm (`METRALE_LM_HEAD_M16_TC`, #927/#928) ────────────────
//
...
/// `METRALE_LM_HEAD_M16_TC_NTILE=64` selects the wide arm; anything unrecognised
...
/// `METRALE_LM_HEAD_BATCHM_MAX=16` recipe would have claimed the same widths.
#[test]
