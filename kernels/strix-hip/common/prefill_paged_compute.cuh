...
// via METRALE_FAST_SOFTMAX_EXP. (HIP/gfx1151: __expf is the transcendental
...
extern "C" __global__ void KERNEL_NAME(
    ...
    // to FP16 per-MMA in registers. Bisect: METRALE_DISABLE_FP16_PV reverts to
    ...
    for (unsigned int kv_block = 0; kv_block < num_kv_blocks; kv_block++) {
        ...
        // Bisect: METRALE_DISABLE_FP16_PV restores the pre-#90 BF16 P×V WMMA.
        {
            #pragma unroll
...
// by cfg!(metrale_scale) in ops/prefill_attn_main_{a,b}.rs, and the two MUST
