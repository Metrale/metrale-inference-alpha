  ...
  <div class="wide2">
    ...
    <aside class="side at" style="--n: 2">
      ...
      <p>
        ...
        into the output as <code class="mono">driver_sha256</code>. The published Metrale Engine legs carry
        <code class="mono">{claim.harnessShaMetrale}</code>; the copy in the repository today hashes
  ...
  <div class="at" style="--n: 1">
    <Cmd
      ...
      lines={[
        ...
        `  timeout 21600 ./target/release/met benchmark run "$g" \\`,
  ...
  <div class="two">
    ...
    <div class="at" style="--n: 2">
      <p class="lead">
        ...
        non-overlapping distributions — Metrale Engine's worst rep beat vLLM's best.
      </p>
      <p class="lead">
...
>
  <div class="mech">
    ...
    <article class="at" style="--n: 3">
      ...
      <p>
        It is not that Metrale Engine gets faster — it is that vLLM's C=128 falls <em>below</em> its own
        C=64 when speculation stays on at high concurrency. Metrale Engine's ladder has already switched it
