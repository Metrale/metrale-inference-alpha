...
MARKER="METRALE_TTFT_OVERNIGHT_2026_03_23"
...
codex_lines=$(ps -eo pid,ppid,etime,cmd | grep -E '/codex exec --dangerously-bypass-approvals-and-sandbox -C /workspace/metrale' | grep -v grep || true)
...
fingerprint=$(
  {
    git status --short -- \
      ...
      crates/gpu-runtime/src/cuda_backend.rs \
