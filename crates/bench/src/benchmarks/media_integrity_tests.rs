...
//! 2026-09-26: Tests for the integrity cells and the request shapes. The
//! checks themselves need a served model; these cover `Cell` and the request
//! bodies.
//!
...
/// 2026-09-26: A skip must not count as measured: a suite that skipped
/// everything and reported a pass stops testing a capability without anyone
...
/// 2026-09-26: The mime is carried through rather than assumed to be PNG: the
/// vision driver also sends JPEG images.
#[test]
