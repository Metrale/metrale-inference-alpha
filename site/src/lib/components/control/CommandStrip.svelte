...
<script>
  ...
  //
  // Left, identity and trust: the Metrale Engine mark (the way back to the site the
...
<header class="cmd" aria-label="Fleet command strip">
  <div class="cmd-left">
    <a class="cmd-mark" href="/" aria-label="Metrale Engine home" data-sveltekit-reload>
      <img src="/favicon.svg" alt="" width="20" height="20" />
      <span>Metrale Engine</span>
    </a>
