...
Host unpack SSOT is `metrale_core::mxfp4_e8m0` (moved from `spark_model::weight_map::fp8_lut`). Same LUT, nibble order, exp=0/255 → 0.0. Gate tip: this commit on `feat/k3-situ-latentmoe`. GPU GEMM remains DSV4 extra_cu, not a second stack.
