...
impl TransformerModel {
    pub(super) fn decode_verify_graphed_k4_dispatch(
        ...
        // METRALE_LORA_EAGER: LoRA graph-vs-eager debugging hatch (see decode_a).
        let lora_eager = self.lora.is_some() && self.levers.lora_eager;
        // METRALE_K4_DIAG=1: run the K=4 verify EAGERLY (no CUDA graph) with a
        ...
        // opaque status-700 on the post-graph D2H. Mirrors METRALE_K2_DIAG on
        ...
        //
        // 🪤 Deliberately does NOT read `METRALE_EP_GRAPHS`; see verify_c.rs for why the two
        // are gated apart.
        ...
        if need_run {
            ...
            for (layer_idx, layer) in self.layers.iter().enumerate() {
                ...
                // METRALE_K4_DIAG checkpoint: surface an illegal access at the
            ...
            if use_graphs {
                ...
                if graph.0 != 0 {
                    ...
                    // BISECT HATCH (METRALE_GLM_VERIFY_GRAPH_NOCACHE=1) — see verify_c.rs.
