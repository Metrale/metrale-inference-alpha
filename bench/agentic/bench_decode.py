...
for i in range(3):
    ...
    r=urllib.request.Request(os.environ.get('METRALE_URL','http://localhost:8888/v1/chat/completions'),data=json.dumps(b).encode(),headers={'Content-Type':'application/json'})
