...
# 2026-09-26: Per-sublayer reference vectors for LongCat layer 0 (last token), checked against the golden layer0_out.
#
# Owner: bench, n-gram reference.
# Invariants: none beyond the types.
"""Per-SUBLAYER reference intermediates for layer 0, to bisect the Metrale Engine
LongCat backbone against `METRALE_OP_DUMP` output.
...
for s in range(2):
    ...
    # 2026-09-26: The engine dumps the dense FFN output as "moe_out" and the
    # shortcut MoE as "shortcut_moe_out"; both are recorded here to match.
