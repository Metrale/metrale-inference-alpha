# 2026-09-26: Cross-sequence bleed probe: concurrent prompts, each checked for another's nonce.
#
...
# 2026-09-26: (nonce, prompt, marker words). Only the nonce is scored; the marker
# words are not read.
STREAMS = [
