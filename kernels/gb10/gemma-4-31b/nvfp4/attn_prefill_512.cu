...
// Owner: gb10 kernels (gemma-4-31b). Invariants: none checked; assumes 448 < head_dim <= 512, since a lane whose 64-dim slice starts at or past head_dim returns before the full-warp shuffles, and num_kv_heads | num_q_heads.
#include <cuda_bf16.h>
