...
// 2026-09-25: Two-token FP8 MoE GEMVs on the transposed layout. Owner: gb10 kernels.
// Invariants: those of moe_shared_expert_fused_fp8_t.cu; blockIdx.y = 2 * top_k + t is token t's shared expert.
#include <cuda_bf16.h>
#include <cuda_fp8.h>
