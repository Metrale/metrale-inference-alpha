...
By contributing, you agree to the [Contributor License Agreement](https://github.com/Metrale/metrale-inference-alpha/blob/main/CLA.md). Your work goes out under AGPL-3.0 in the Community Edition, and you grant Metrale Engine the right to relicense for the Enterprise Edition.
