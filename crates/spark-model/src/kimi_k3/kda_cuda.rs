...
//! CPU oracle: [`metrale_core::kimi_k3::kda_decode_token`]. BoundLayer serve
//! LinearAttention default is this launch (`K3_CUDA_KDA=0` keeps CPU).

use anyhow::{Context, Result, bail, ensure};
use metrale_core::kimi_k3::{KDA_L2_EPS, KdaConfig, KdaState};
...
mod tests {
    use super::*;
    use metrale_core::kimi_k3::kda_decode_token;
