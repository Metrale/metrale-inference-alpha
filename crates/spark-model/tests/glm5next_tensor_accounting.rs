...
/// `.planning/METRALE-GLM5NEXT-SKILL-RECONCILIATION-20260826.md`.
...
///     every quantised projection. Metrale Engine serves w4a16 and never reads it;
...
/// so an unused tensor must still be CLASSIFIED — "Metrale Engine ignores it" and "the
