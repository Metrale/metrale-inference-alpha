...
MAIN_PROMPT=$(cat <<'EOF'
Metrale Engine repo. Tonight's primary goal is to reduce long-context TTFT for 16K+ prompts, especially 32K and 64K, toward roughly 20% of the former latency baseline while preserving TPOT and coherence.
...
Metrale Engine repo. This is an overnight rescue/nudge run for the long-context TTFT effort.
