...
//! 2026-09-26: Tests for the serve-matrix table, tiles and verdict, including the
//! rows for rounds that did not run.
//!
...
fn every_candidate_gets_a_row_including_the_ones_that_were_skipped() {
    ...
    // 2026-09-26: The verdict is the last column, so the test reads the last
