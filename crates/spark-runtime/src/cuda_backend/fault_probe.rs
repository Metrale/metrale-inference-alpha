...
//! verdict held by [`metrale_core::fault`]. The decision itself is that module's
//! pure [`classify`](metrale_core::fault::classify); everything here is the
//! probe it needs.
//!
//! # The probe
//!
...
fn probe() -> Result<(), String> {
    ...
    if status == 0 {
        ...
        Err(metrale_core::registry::cuda_error_text(status))
    }
}
