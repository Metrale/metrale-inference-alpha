...
# 2026-09-26: HF CPU forward of the probe prompt with hooks on GDN layers; writes the reference dumps.
#
...
Token IDs were captured from metrale-35b-a3b-fix via POST /tokenize for the
...
# 2026-09-26: The probe prompt's 31 token IDs; the docstring shows its text.
