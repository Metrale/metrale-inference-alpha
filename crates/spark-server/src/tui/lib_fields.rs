...
//! What the Config form knows about `met serve` flags it could add or pick.
//!
...
/// One addable `met serve` flag, shaped for the form.
#[derive(Clone, Debug)]
...
/// Every `met serve` flag the form can carry, built once per process (the
