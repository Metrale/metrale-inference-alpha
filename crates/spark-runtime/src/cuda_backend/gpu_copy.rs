...
//!
//! `impl GpuBackend for MetraleCudaBackend` cannot be split across files —
...
//!   here: `MetraleCudaBackend::live_allocs` is a `HashSet<u64>` of base pointers
...
use metrale_core::registry::cuda_error_text;
...
impl MetraleCudaBackend {
    ...
    pub(crate) fn copy_d2h_on_stream_impl(
        ...
        // METRALE_D2H_SPIN_SYNC=1: poll cuStreamQuery instead of parking in the
