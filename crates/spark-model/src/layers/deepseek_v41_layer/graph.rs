...
//! The captured single-token step (`METRALE_DS41_GRAPH=1`): the step split into
...
impl DeepSeekV41Layer {
    ...
    /// `METRALE_DS41_GRAPH_ORACLE=1`: the captured step, then the highway put
    ...
    /// The per-step diagnostic line (`METRALE_DS41_DIAG=1`), from the last layer.
