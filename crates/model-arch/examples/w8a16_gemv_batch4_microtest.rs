...
//! 2026-09-25: Cosine check of `w8a16_gemv_batch4` (M = 4) and `w8a16_gemv_batch16`
//! (M = 8, 16) against M single-row `w8a16_gemv` launches, at one `[512 x 2048]`
//! shape. Each row must reach cosine > 0.99999; the byte-exact gate is
//! `w8a16_batch_bitparity_microtest`.
//!
//! Owner: model-arch examples.
//! Invariants: none beyond the types.
//!
//! Run:
//!   METRALE_TARGET_HW=gb10 METRALE_TARGET_MODEL=holo-3.1-35b-a3b METRALE_TARGET_QUANT=nvfp4 \
...
fn main() -> Result<()> {
    ...
    let a: Vec<bf16> = (0..MAXM * K)
        ...
        .collect();
    // 2026-09-25: Random FP8 E4M3 weight bytes; both kernels' tables decode the
    // NaN codes 0x7F/0xFF as zero.
