...
Purpose
-------
Metrale-Spark's Gemma-4-31B (NVFP4) produces degenerate output starting around
...
Relevant Metrale Engine files:
    /workspace/metrale/crates/spark-model/src/layers/qwen3_attention/trait_impl.rs
        - decode forward + `gemma4_diag_enabled()` instrumentation
    /workspace/metrale/crates/spark-model/src/weight_loader/gemma4.rs
