...
pub struct Usage {
    ...
    /// Populated when Metrale Engine's prefix cache served any portion of the prompt.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct PromptTokensDetails {
    ...
    /// Audio-input tokens. Always 0 on Metrale Engine until audio modality lands.
...
pub struct CompletionTokensDetails {
    ...
    /// Audio-output tokens. Always 0 on Metrale Engine until audio modality lands.
    pub audio_tokens: usize,
    /// Predicted tokens that matched generation. Metrale Engine has no client-supplied
    ...
    /// Predicted-output tokens that were rejected. Always 0 on Metrale Engine —
...
impl ModelInfo {
    ...
    pub fn advertise(id: String, max_seq_len: usize) -> Self {
        Self {
            ...
            owned_by: "metrale-spark".to_string(),
