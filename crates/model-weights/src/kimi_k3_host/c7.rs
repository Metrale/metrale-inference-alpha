...
//! 2026-09-26: C7: dummy TP=2 column-split `o_proj` + allreduce == unsplit TP=1 tokens.
//!
//! The two ranks run in-process, one after the other, and the allreduce is a
//! sum (`ops::matvec_column_tp`); no NCCL call is made.
