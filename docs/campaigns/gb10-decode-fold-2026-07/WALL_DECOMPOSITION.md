...
streaming first-flush. **vLLM's min TTFT on this same harness and box is 616 ms** (best Metrale run 650,
golden 782), which bounds how much of the constant can be Metrale-specific — plausibly ~260 ms/turn
