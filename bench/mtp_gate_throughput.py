...
# 2026-09-26: Single-stream decode tok/s over N sequential temperature-0 requests.
#
# Owner: bench.
...
for i in range(RUNS):
    ...
    # 2026-09-26: Prefer the server-reported decode rate; fall back to tokens / wall.
