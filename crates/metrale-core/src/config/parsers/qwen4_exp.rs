...
//!      streams, mixed by a LOW-RANK pair of rank `hc_lowrank` (320). Metrale Engine
...
//! tower, gated attention — lands on fields Metrale Engine already has.
//!
...
pub(crate) fn parse_qwen4_exp(raw: &Value) -> Result<ModelConfig> {
    ...
    // SiLU is the family default Metrale Engine's kernels hardcode; "sigmoid" here
