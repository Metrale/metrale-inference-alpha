...
// 2026-09-25: Paged decode attention over a turbo8 KV cache. HDIM is 512, fixed
// below; run_paged_decode.rs launches it for head_dim > 256.
//
...
// o, then the running max, then the softmax sum. The serve loads
...
#define WARP_SIZE 32
// 2026-09-25: HDIM is 512 whatever -DHDIM the model's KERNEL.toml passes.
#undef HDIM
