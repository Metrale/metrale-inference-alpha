...
# 2026-09-26: Tests that harness_w56's one_request reports failed or truncated streams as errors.
#
...
class StreamEnd(unittest.TestCase):
    ...
    def test_completed_streams_still_succeed(self):
        # 2026-09-26: Negative controls: a stream that ends in [DONE], or in a
        # finish_reason chunk then EOF, is not an error.
