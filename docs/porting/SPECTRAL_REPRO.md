...
3. What does `cuModuleLoadData` accept as a code-object format (relevant
   once device init works — Metrale Engine loads kernels via `cuModuleLoadData`)?
...
Metrale Engine builds and links cleanly on Strix Halo via SCALE 1.7.0 and runs to
