    ...
    fn load_layers(
        ...
        for (i, lt) in layer_types.iter().enumerate() {
            ...
            match lt {
                ...
                metrale_core::config::LayerType::SparseAttention => anyhow::bail!(
                    "layer {i}: SparseAttention (deepseek_sparse_attention) has no Nemotron loader"
                ),
                metrale_core::config::LayerType::Moe => {
                ...
                metrale_core::config::LayerType::FullAttention => {
                    ...
                    let (q_nv, k_nv, v_nv) = if is_nvfp4 {
                        ...
                        // they exist for. `METRALE_NEMOTRON_BF16_ATTN=0` restores
