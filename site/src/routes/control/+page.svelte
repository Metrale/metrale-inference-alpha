...
<svelte:head>
  <title>Control plane — Metrale Engine</title>
  <meta
    name="description"
    content="Manage the Metrale Engine agents on your own machines: node health, pairing, topology and multi-node launches. Everything stays on your LAN."
  />
</svelte:head>
        ...
        <div class="ctl-modes">
          {#if fleet.mode === 'reconnecting'}
            ...
            <div class="ctl-setup">
              ...
              <p>
                ...
                <code class="mono">metralectl agent status</code>, or start it again with
          ...
          {:else}
            ...
            <div class="ctl-setup">
              ...
              {/if}
              <p>
                Metrale Engine runs on your hardware, not ours. Install the agent on a machine
              ...
              <p class="ctl-safety">
                ...
                <strong>dev.metrale.ai</strong> before running one.
              </p>
            </div>
          {/if}
        </div>
