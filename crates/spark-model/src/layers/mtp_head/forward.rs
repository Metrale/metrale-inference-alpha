...
/// MTP-debug (METRALE_MTP_DEBUG_NORMS=1): L2 norm of a BF16 GPU buffer, for
...
impl MtpHead {
    ...
    pub(crate) fn forward_one(
        ...
        // MTP-debug (METRALE_MTP_DEBUG_NORMS=1): localize the constant-0 draft.
        ...
        // 13a. Drafter chain confidence (METRALE_MTP_DRAFT_CONF > 0):
        ...
        // 13b. Shadow top-k (METRALE_MTP_SHADOW_TOPK=k): observational only.
        ...
        state.seq_len += 1;
        // Pair-key bookkeeping (METRALE_MTP_CATCHUP gap detection): this call
