# 2026-09-26: Sums the tensor bytes in a local NVFP4 snapshot's safetensors headers
# and prints their size distribution and the footprint at four allocation granularities.
#
...
for f in sorted(set(wm.values())):
    ...
    for k, v in hdr.items():
        ...
        if 'ngram_embedding.shard_' in k:
            continue  # 2026-09-26: kept on disk by the loader (weight_loader/qwen4_exp/ple.rs).
        nel = 1
        for d in v['shape']:
            nel *= d
