...
// 2026-09-25: Three-token NVFP4 MoE GEMVs on the transposed layout, shared expert included.
// Owner: gb10 kernels.
// Invariants: as in moe_shared_expert_fused_batch2_t.cu, for three tokens: blockIdx.y
// < 3 * top_k is routed slot y and y = 3 * top_k + t is token t's shared expert; 32
// threads per block; K a multiple of 16; a null weight pointer writes zeros.
#include <cuda_bf16.h>
#include <cuda_fp8.h>
