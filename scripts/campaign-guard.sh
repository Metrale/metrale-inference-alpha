...
# crates/model-arch/src/weight_loader/qwen4_exp/ffn.rs — a PERF_PATH. Records
...
#
# Superseded for campaigns by `met bench certify`, which carries the same
...
COVERAGE=crates/bench/src/gate/coverage.rs
