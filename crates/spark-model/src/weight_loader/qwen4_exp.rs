...
//! `Qwen3.8-Flash-Next` (`qwen4_exp`) weight loader. Port tracked in Metrale Engine
//! #753.
//!
...
//!   `METRALE_QWEN4EXP_NO_PLE=1`, because skipping it does not crash and does
...
//! 2. **mHC is 4 residual streams**, mixed low-rank (rank 320). Metrale Engine's mHC
...
impl ModelWeightLoader for Qwen4ExpWeightLoader {
    ...
    fn load_mtp_weights(
        ...
        // own QSA indexer, and `fc_embedding`/`fc_hidden` where Metrale Engine's
