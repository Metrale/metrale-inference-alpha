...
//! 2026-09-25: Parity of the vision-tower kernels `conv3d_patch_embed`,
//! `dense_gemm_bf16`, `dense_gemv_bf16`, `layer_norm` and `gelu`.
//!
...
/// 2026-09-25: `conv3d_patch_embed` with stride equal to the kernel (2x4x4 over 3
/// input channels, 4 output channels) against an FP32 reference.
#[test]
...
/// 2026-09-25: `dense_gemm_bf16` (m = 4, n = 8, k = 64) against an FP32 reference;
/// `w` is `[N, K]` row-major, the layout `dense_gemv_bf16` takes too.
#[test]
...
/// 2026-09-25: `dense_gemv_bf16` (n = 16, k = 256) against an FP32 reference.
#[test]
...
/// 2026-09-25: `layer_norm` against the FP32 reference
...
/// 2026-09-25: `gelu` (tanh approximation) against an FP32 reference, for x from
/// -3 to 3.
#[test]
