...
//! Server initialization and runtime: phases 0-11 of the Metrale Engine startup sequence.
//!
...
fn startup(
    ...
    tracing::info!("Metrale Engine Spark starting...");
    ...
    // read them. Each of these used to be an `METRALE_*` variable read at its own
