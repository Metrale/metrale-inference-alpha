...
// full Metrale Engine runtime / kernel registry. Only the symbols the probe needs.
...
// of the underlying memory must coordinate externally (Metrale Engine does this
