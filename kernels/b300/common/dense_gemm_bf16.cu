...
// Metrale Engine Dense GEMM kernel for SM121 (GB10).
//
// C = A * B^T  where:
...
// METRALE_FP32_GATE routing path for the MoE router GEMM so the gate logits
...
// The METRALE_FP32_ROUTING gate GEMM: full-precision activation × bf16 gate weight
