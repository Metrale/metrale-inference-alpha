...
pub struct Glm5NextMhcKernels {
    ...
    ///
    /// 🪤 This is an architecture-neutral broadcast that Metrale Engine already had — and GLM still
...
/// `METRALE_GLM_PREFILL_ROWS`** that has nothing to do with memory. At 512 rows the serve boots
...
mod mhc_shape_tests {
    ...
    /// `METRALE_GLM_PREFILL_ROWS` in the environment — the state of a test process — the
