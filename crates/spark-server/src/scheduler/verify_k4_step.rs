...
pub fn step_verify_k4(
    ...
    // `METRALE_MTP_TIMING=1` summary for the K=4 path.
    //
    ...
    // Shadow top-k target line (METRALE_MTP_SHADOW_TOPK): joins offline with
    ...
    // Width-attributed accept telemetry (METRALE_MTP_ACCEPT_DEBUG): this is the
    ...
    // METRALE_MTP_REFEED_ACCEPTED: same contract as `verify_k3_step` — ring the
    ...
    // diagnostics: `RUST_LOG=met::scheduler::verify_k4_step=debug`.
    tracing::debug!(
