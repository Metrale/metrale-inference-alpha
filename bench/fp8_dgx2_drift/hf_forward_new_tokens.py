#!/usr/bin/env python3
"""HF[FP8->BF16] forward on Metrale-on-dgx2's freshly-dumped 9780-token prompt.

Loads /tmp/metrale_tokens_dgx2.json (which contains the EXACT token IDs Metrale Engine
...
states to /workspace/metrale-dumps/fp8native_dgx2/hf_L{0..39}.bin.

This produces a fresh reference matching the new token sequence, replacing
the stale 18920-token reference at /workspace/metrale-dumps/fp8dequant/hf_L*.bin.
"""
