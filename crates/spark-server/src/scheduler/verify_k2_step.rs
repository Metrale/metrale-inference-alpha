...
pub fn step_verify_k2(
    ...
    // METRALE_MTP_CATCHUP: ring the target's true hidden for the positions this step
    ...
    if accepted {
        ...
        // EAGLE-fix (METRALE_DFLASH_EAGLE_FIX=1, K=2 accept only): append row 0 @ N
        ...
        // `RUST_LOG=met::scheduler::verify_k2_step=debug`. The
