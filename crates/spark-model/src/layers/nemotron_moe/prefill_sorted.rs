...
impl NemotronMoeLayer {
    pub(super) fn prefill_sorted_path(
        ...
        // rather than merely being wrong. `METRALE_MOE_NO_ZERO_INTERMEDIATES=1` skips.
        ...
        // not work. `METRALE_MOE_MAX_M_TILES_ESTIMATE=1` restores the old bound for an
        ...
        // fused. OPT-IN ONLY (METRALE_MOE_W4A4=1): although the latent is a linear
        ...
        // normed-input W4A4 GEMMs stayed clean. METRALE_SHARED_W4A4_DOWN=1 to test.
