# 2026-09-25: Audit of the GLM-5.3-Flash checkpoint's FFN/MoE tensors (dtypes, shapes, per-layer
# signatures), then extraction of router, dense-FFN and layer-3 MoE packets to safetensors files.
#
