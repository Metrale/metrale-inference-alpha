...
// 2026-09-26: Matrix multiply with MLX 8-bit weights dequantized inline, in the format
// mlx_int8_dequant reads:
//
//   Y[m, n] = sum over k of (X[m, k] * W_dequant[n, k])
//
// One thread per (m, n) output element; it loops over K with FP32 accumulation.
//
// Layout:
//   x      : bfloat [M, K]
//   packed : uint32 [N, K / 4]
