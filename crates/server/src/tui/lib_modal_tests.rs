...
//! 2026-09-26: Tests for the add-picker's help-panel scroll in `lib_modal.rs`: its keys, clamp and reset.
//!
//! Owner: server tui.
...
/// 2026-09-26: The add picker with its cursor on `check_kernels`, whose help has several paragraphs.
