...
//! `METRALE_CUBLAS_GEMM=ffn,ssm,attn` (`nsys-r9-prefill`). A 1193-token prefill
...
//!      microtests state. `METRALE_W8A8_REL_RMS_GATE` overrides it.
//!
...
//! cuBLASLt directly, so `METRALE_CUBLAS_GEMM` is not required here — the serve
