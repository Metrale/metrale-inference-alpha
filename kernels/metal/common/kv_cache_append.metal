...
// 2026-09-26: Append one token's K and V projections into a contiguous KV cache at slot
// `cache_pos`.
//
// Layout:
...
//
// Grid: (head_dim, num_kv_heads, 1), one thread per element of the token's slot.
